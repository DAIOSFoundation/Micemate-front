import{r as h,j as e}from"./react-GgNxsn6d.js";import{c as ft}from"./react-dom-QkaEqh-z.js";import{R as Ce,a as Ee,b as W,c as bt,d as ue,e as ut}from"./recoil-D-jwd32P.js";import{u as pe,a as J,b as Fe,Q as gt,c as yt,R as Nt}from"./@tanstack-BdwTvngC.js";import{L as w,c as wt,R as vt}from"./react-router-dom-C9w1ezDZ.js";import{d as Se,f as kt}from"./styled-components-PsS2HYcQ.js";import{d as xe,c as _e,O as At,f as he}from"./react-router-xw_WwrXM.js";import{a as Ct}from"./axios-CCb-kr4I.js";import{u as ve}from"./react-hook-form-rx1EpASO.js";import{t as Pe}from"./@hookform-BTSKDkxf.js";import{o as Te,s as Ae,b as St,n as Yt}from"./zod-D7J-fcuR.js";import{C as Et}from"./react-spinners--gswIwTH.js";import{d as v,a as Ft,l as Pt}from"./dayjs-CN69eQz1.js";import{R as Tt}from"./react-quill-DpUnCd_1.js";import"./scheduler-CzFDRTuY.js";import"./@remix-run-Va2Jh8gM.js";import"./@emotion-sScrWPmR.js";import"./stylis-DinRj2j6.js";import"./lodash-DSq4vvuY.js";import"./quill-DGDbI1on.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))t(c);new MutationObserver(c=>{for(const p of c)if(p.type==="childList")for(const r of p.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&t(r)}).observe(document,{childList:!0,subtree:!0});function l(c){const p={};return c.integrity&&(p.integrity=c.integrity),c.referrerPolicy&&(p.referrerPolicy=c.referrerPolicy),c.crossOrigin==="use-credentials"?p.credentials="include":c.crossOrigin==="anonymous"?p.credentials="omit":p.credentials="same-origin",p}function t(c){if(c.ep)return;c.ep=!0;const p=l(c);fetch(c.href,p)}})();const ct=Se.div`
...
`;function Ot({children:s}){const i=xe();return h.useEffect(()=>{window.scrollTo(0,0)},[i.pathname]),e.jsx("div",{children:s})}const zt=Se.div`
  position: fixed;
  inset: 0;
  z-index: 1000;
  color: #000;
...
`,Mt=Ce({key:"alretState",default:{isOpen:!1,text:""}}),H=Ce({key:"confirmState",default:{isOpen:!1,text:"",confirm:!1,okBtn:"취소하기"}}),$t=Ce({key:"toastState",default:{isOpen:!1,text:""}}),je=()=>{const[s,i]=Ee(Mt),l=h.useCallback(()=>{i(c=>({...c,isOpen:!1})),s!=null&&s.callBack&&s.callBack()},[i,s]),t=h.useCallback(({text:c,callback:p})=>i({isOpen:!0,text:c,callBack:p}),[i]);return{alretData:s,closeAlret:l,openAlret:t}},qt=()=>{const{alretData:s,closeAlret:i}=je();return e.jsx(e.Fragment,{children:s.isOpen&&e.jsxs(zt,{children:[e.jsx("div",{className:"dim_layer"}),e.jsxs("div",{className:"modal_inner",children:[e.jsx("button",{className:"modal_close",onClick:i}),e.jsx("div",{className:"modal_body",children:e.jsx("div",{className:"modal_tit",children:s.text})}),e.jsx("div",{className:"modal_btn",children:e.jsx("button",{className:"close_btn",onClick:i,children:"확인"})})]})]})})},Bt=Se.div`
  position: fixed;
  inset: 0;
  z-index: 1000;
  color: #000;
...
`,ge=()=>{const[s,i]=Ee(H),l=W(H),t=h.useCallback(({confirm:p,callback:r})=>{i(_=>({..._,isOpen:!1,confirm:p,callback:r}))},[i]),c=h.useCallback(({text:p,okBtn:r,type:_})=>i({isOpen:!0,text:p,confirm:!1,okBtn:r,type:_??""}),[i]);return{confirmData:s,confirmValue:l,closeConfirm:t,openConfirm:c}},Rt=()=>{const{confirmData:s,closeConfirm:i}=ge();return e.jsx(e.Fragment,{children:s.isOpen&&e.jsxs(Bt,{children:[e.jsx("div",{className:"dim_layer"}),e.jsxs("div",{className:"modal_inner",children:[e.jsx("button",{className:"modal_close",onClick:()=>i({confirm:!1})}),e.jsx("div",{className:"modal_body",children:e.jsx("div",{className:"modal_tit",children:s.text})}),e.jsxs("div",{className:"modal_btn",children:[e.jsx("button",{className:"confirm_btn",onClick:()=>i({confirm:!0}),children:s.okBtn}),e.jsx("button",{className:"close_btn",onClick:()=>i({confirm:!1}),children:"취소"})]})]})]})})},Oe=()=>{const[s,i]=Ee($t),l=h.useCallback(()=>{i({isOpen:!1,text:""})},[]),t=h.useCallback(c=>{i({isOpen:!0,text:c});const p=setTimeout(()=>{l()},3e3);return()=>clearTimeout(p)},[l]);return{toastData:s,openToast:t,closeToast:l}},It=Se.div`
  position: fixed;
  bottom: 48px;
  color: #fff;
...
`;function Xs(){return e.jsxs(e.Fragment,{children:[e.jsx(Ks,{}),e.jsx(Js,{})]})}const Ws=new gt;ft(document.getElementById("root")).render(e.jsx(ut,{children:e.jsxs(yt,{client:Ws,children:[e.jsx(Xs,{}),e.jsx(Nt,{})]})}));
