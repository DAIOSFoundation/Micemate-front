...
`,un=Se({email:Z().trim().min(1,"아이디를 입력해주세요.").email({message:"올바른 이메일을 입력해주세요."}),password:Z().trim().min(1,"비밀번호를 입력해주세요.").regex(/^(?=.*[a-zA-Z])(?=.*[0-9]).{8,25}$/," 영문,숫자조합 8자리 이상 입력해주세요."),passwordChk:Z(),name:Z().trim().min(1,"이름을 입력해주세요.").min(2,"이름을 확인해주세요."),birth:Z().trim().min(1,"생년월일을 입력해주세요.").regex(/^\d{4}-\d{2}-\d{2}$/,"올바른 날짜 형식으로 입력해주세요.").refine(t=>{const s=new Date(t);return!isNaN(s.getTime())},"유효한 날짜를 입력해주세요."),gender:Z({message:"성별을 선택해주세요."}),interests:Ne().array().min(1,"관심분야를 최소 하나 이상 선택해야 합니다."),allChk:ee().default(!1).optional(),agree_01:ee(),agree_02:ee().default(!1).optional(),agree_03:ee(),agree_04:ee()}).superRefine(({passwordChk:t,password:s},a)=>{t!==s&&a.addIssue({code:cs.custom,message:"비밀번호를 확인해주세요.",path:["passwordChk"]})}),bn=()=>{var _,P,M,V,T,L,I,E,F,B,R,se,pe,W,X,Le,Fe,Be,Te,Pe,Ze,$e;const[t,s]=i.useState([]),[a,n]=i.useState([]),[l,c]=i.useState(!1),p=Ns(),{openAlret:r}=Ee(),o=D(),{data:f}=Ke(),{register:m,handleSubmit:g,setValue:j,control:d,watch:u,setError:C,formState:{errors:N}}=me({resolver:He(un)}),k=K=>{let q=K.target.value.replace(/\D/g,"");q.length>4&&q.length<=6?q=q.slice(0,4)+"-"+q.slice(4):q.length>6&&(q=q.slice(0,4)+"-"+q.slice(4,6)+"-"+q.slice(6,8)),j("birth",q)},z=K=>{s(q=>q.filter(oe=>oe!==K)),n(q=>q.filter(oe=>oe.id!==K)),j("interests",t.filter(q=>q!==K)),j(`checkbox-${K}`,!1)},S=(K,q)=>{const oe=K.target,ye=oe.value;oe.checked?(s(de=>[...de,q]),n(de=>[...de,{id:q,name:ye}])):(s(de=>de.filter(Ve=>Ve!==q)),n(de=>de.filter(Ve=>Ve.id!==q)))};i.useEffect(()=>{j("interests",t)},[t,j,a]);const H=u("allChk"),v=u("agree_01"),x=u("agree_03"),w=u("agree_04");i.useEffect(()=>{const K=["agree_01","agree_02","agree_03","agree_04"];H===!0?K.forEach(q=>j(q,!0)):K.forEach(q=>j(q,!1))},[H,j]),i.useEffect(()=>{c(!!(v&&x&&w))},[v,x,w]);const $=g(K=>{const q=()=>{if(K.gender==="man")return!1;if(K.gender==="woman")return!0},oe={name:K.name,email:K.email,password:K.password,c_password:K.passwordChk,birth:K.birth,sex:q(),interests:t,terms_of_uses:{1:K.agree_01,2:K.agree_02,3:K.agree_03,4:K.agree_04}};p.mutate(oe,{onSuccess:()=>{r({text:`회원가입이 완료되었습니다.
이메일 인증 후 서비스를 이용할 수 있습니다.`,callback:()=>{o("/login",{replace:!0})}})},onError:ye=>{var de;const ze=ye;console.log(ze.response.data),((de=ze.response)==null?void 0:de.data.message)==="이미 회원이 존재합니다."&&C("apiError",{type:"manual",message:"사용중인 이메일 입니다."})}})});return p.isPending?e.jsx(ve,{}):e.jsx(pn,{children:e.jsxs(xn,{onSubmit:$,children:[e.jsx(rt,{children:e.jsx(at,{type:"text",id:"email",register:m,placeholder:"이메일(ID)"})}),((_=N.email)==null?void 0:_.message)&&e.jsx("p",{className:"err_msg",children:(M=(P=N.email)==null?void 0:P.message)==null?void 0:M.toString()}),e.jsxs(rt,{className:"password",children:[e.jsx(at,{type:"password",id:"password",register:m,placeholder:"비밀번호"}),e.jsx(at,{type:"password",id:"passwordChk",register:m,placeholder:"비밀번호 확인"})]}),((V=N.password)==null?void 0:V.message)&&e.jsx("p",{className:"err_msg",children:(L=(T=N.password)==null?void 0:T.message)==null?void 0:L.toString()}),((I=N.passwordChk)==null?void 0:I.message)&&e.jsx("p",{className:"err_msg",children:(F=(E=N.passwordChk)==null?void 0:E.message)==null?void 0:F.toString()}),e.jsx(rt,{children:e.jsx(at,{type:"text",id:"name",register:m,placeholder:"이름"})}),((B=N.name)==null?void 0:B.message)&&e.jsx("p",{className:"err_msg",children:(se=(R=N.name)==null?void 0:R.message)==null?void 0:se.toString()}),e.jsxs(rt,{children:[e.jsx(at,{id:"birth",register:m,placeholder:"생년월일 8자리",onChange:k}),e.jsxs(hn,{children:[e.jsx(ci,{id:"man",label:"남",name:"gender",register:m}),e.jsx(ci,{id:"woman",label:"여",name:"gender",register:m})]})]}),((pe=N.birth)==null?void 0:pe.message)&&e.jsx("p",{className:"err_msg",children:(X=(W=N.birth)==null?void 0:W.message)==null?void 0:X.toString()}),((Le=N.gender)==null?void 0:Le.message)&&e.jsx("p",{className:"err_msg",children:(Be=(Fe=N.gender)==null?void 0:Fe.message)==null?void 0:Be.toString()}),e.jsx(rt,{children:e.jsx(rn,{text:"관심 분야",children:e.jsx(mn,{children:e.jsx(Ce,{name:"interests",control:d,render:({field:K})=>e.jsx(e.Fragment,{children:f&&K&&f.map(q=>e.jsx(Ue,{label:q.name,id:`checkbox-${q.id}`,onChange:oe=>{S(oe,q.id)},register:m},q.id))})})})})}),a.length>=1&&e.jsx(Bi,{hashList:a,onClick:z}),N.interests&&e.jsx("p",{className:"err_msg",children:(Pe=(Te=N.interests)==null?void 0:Te.message)==null?void 0:Pe.toString()}),e.jsxs(gn,{children:[e.jsx(Ue,{label:"선택 포함 전체 약관 동의",id:"allChk",register:m}),e.jsxs("div",{children:[e.jsxs("div",{className:"required_box",children:[e.jsx(Ue,{label:"이용약관 동의 (필수)",id:"agree_01",register:m}),e.jsx("p",{className:"link",children:e.jsx(b,{to:"/terms-service",target:"blank_",children:"약관 보기"})})]}),e.jsx(Ue,{label:"이벤트 혜택 알림 수신 동의 (선택)",id:"agree_02",register:m}),e.jsxs("div",{className:"required_box",children:[e.jsx(Ue,{label:"성별, 생년 정보 제공 동의 (필수)",id:"agree_03",register:m}),e.jsx("p",{className:"link",children:e.jsx(b,{to:"/gender-birth-information",target:"blank_",children:"내용 확인"})})]}),e.jsxs("div",{className:"required_box",children:[e.jsx(Ue,{label:"개인 정보 수집 및 이용 동의 (필수)",id:"agree_04",register:m}),e.jsx("p",{className:"link",children:e.jsx(b,{to:"/personal-information",target:"blank_",children:"내용 확인"})})]})]})]}),N.apiError&&e.jsx("p",{className:"err_msg",children:($e=(Ze=N.apiError)==null?void 0:Ze.message)==null?void 0:$e.toString()}),e.jsx(fn,{disabled:!l,className:"btn",children:"회원가입"})]})})},_n=h.div`
  @media (max-width: 1024px) {
    padding: 0 16px;
  }
`,jn=h.div`
...
`,kn=Se({email:Z().email({message:"올바른 이메일을 입력해주세요."}),password:Z(),remember:ee()}),Hn=()=>{var d,u,C,N;const[t,s]=i.useState(!1),a=ke(he),n=ks(),l=D(),{register:c,handleSubmit:p,setError:r,watch:o,formState:{errors:f}}=me({resolver:He(kn)}),m=o("email"),g=o("password");i.useEffect(()=>{m!=null&&m.trim()&&(g==null?void 0:g.trim())!==void 0?s(!0):s(!1)},[m,g]);const j=p(k=>{const z={email:k.email,password:k.password,remember:k.remember};n.mutate(z)});return i.useEffect(()=>{n.isSuccess&&(a.data.is_company===!0?l("/host-main",{replace:!0}):l("/",{replace:!0}))},[n.isSuccess,l,a.data.is_company]),i.useEffect(()=>{var k,z,S;if(n.isError){const H=n.error;(S=(z=(k=H==null?void 0:H.response)==null?void 0:k.data)==null?void 0:z.data)!=null&&S.error?H.response.data.data.error==="Unauthorised"?r("apiError",{type:"manual",message:"이메일 또는 비밀번호를 확인해주세요."}):r("apiError",{type:"manual",message:H.response.data.data.error}):r("apiError",{type:"manual",message:"알 수 없는 오류가 발생했습니다."})}},[n.isError,n.error,r]),e.jsxs(_n,{children:[e.jsxs(jn,{children:[e.jsx("h2",{children:"LOGIN"}),e.jsx("span",{children:"즐거운 만남을 시작해보세요!"})]}),e.jsxs(wn,{onSubmit:j,children:[e.jsxs("div",{className:"input_box",children:[e.jsx(Et,{label:"이메일(ID)",type:"text",id:"email",placeholder:"이메일 입력",register:c}),e.jsx(Et,{label:"비밀번호",type:"password",id:"password",placeholder:"비밀번호 입력",register:c})]}),f.email&&e.jsx("p",{className:"err_msg",children:(u=(d=f.email)==null?void 0:d.message)==null?void 0:u.toString()}),f.apiError&&e.jsx("p",{className:"err_msg",children:(N=(C=f.apiError)==null?void 0:C.message)==null?void 0:N.toString()}),e.jsx("div",{className:"login_stay",children:e.jsx(Ae,{label:"로그인유지",id:"remember",register:c})}),e.jsx(vn,{disabled:!t,children:"로그인"})]}),e.jsxs(yn,{children:[e.jsx(b,{to:"/login/password-find",children:"비밀번호 찾기"}),"   |   ",e.jsx(b,{to:"/join",children:"회원가입"})]}),e.jsx(Cn,{}),e.jsx(Nn,{className:"desc_btn",children:e.jsx(b,{to:"/privacy-policy",children:"개인정보 처리방침"})})]})},Sn=h.div`
  width: 384px;
  margin: 0 auto 160px;
  @media (max-width: 1024px) {
    width: 100%;
...
`,Wn=({id:t,title:s,img:a,event_start_date:n,event_end_date:l,position:c,date:p,is_booth:r,liked_booth:o,url:f,eventState:m})=>{const g=Ha(),j=Ft(),d=localStorage.getItem("token"),u=localStorage.getItem("user_id"),{openAlret:C}=Ee(),{openConfirm:N,confirmValue:k}=Ye(),z=Vt(),[S,H]=i.useState(!1),[v,x]=i.useState(""),w=je(Me),[$,_]=i.useState(!0);i.useEffect(()=>{H(k.confirm)},[k.confirm]),i.useEffect(()=>{if(S===!0&&v.length>0){const V={token:d,event_id:v};g.mutate(V)}},[S]);const P=V=>{N({text:"취소하시겠습니까? 취소 확정 후에는 복구하실 수 없습니다.",okBtn:"취소하기",logout:!1}),x(V)};i.useEffect(()=>{if(g.isSuccess){const V={text:"취소가 완료되었습니다."};H(!1),w(),x(""),C(V),z.invalidateQueries({queryKey:["myEvent"]})}g.isError&&(H(!1),x(""))},[g.isSuccess,g.isError]);const M=V=>{const T={token:d,user_id:u,event_id:V};j.mutate(T),_(L=>!L)};return e.jsxs(Pn,{children:[e.jsx(Zn,{children:e.jsxs(b,{to:`/detail/${t}`,children:[m.state==="cancel"&&e.jsx("span",{className:"blind",children:"취소완료"}),e.jsx("img",{src:`https://api-test.micemate.io/storage/${a}`})]})}),e.jsxs($n,{children:[e.jsxs(In,{children:[p&&e.jsxs("div",{className:"apply",children:[e.jsx("span",{className:"state",children:m.label}),e.jsxs("span",{className:"date",children:["신청일 : ",p]})]}),e.jsxs("div",{className:"txt_box",children:[e.jsx("span",{className:"title",children:s}),e.jsx("span",{className:"date",children:`${ft(n)} ~ ${ft(l)}`}),e.jsx("span",{className:"location",children:c})]})]}),m.state==="apply"&&e.jsxs(On,{children:[e.jsx(b,{to:`/detail/${t}/apply/edit`,children:"수정"}),"  |  ",e.jsx("button",{onClick:()=>P(JSON.stringify(t)),children:"취소"})]}),m.state==="apply"&&e.jsxs(qn,{children:[r&&o&&e.jsx(b,{to:`/mypage/apply-list/booth-check/${t}`,children:"AI 추천 부스 보기"}),r&&!o&&e.jsx(b,{to:`/mypage/apply-list/booth-select/${t}`,children:"AI 추천 부스 받기"}),f&&e.jsx(b,{to:f,target:"_blank",children:"행사 접속하기"})]}),m.state==="wish"&&e.jsx(Rn,{children:e.jsx("button",{onClick:()=>M(t),children:$?e.jsx(Si,{}):e.jsx(Ei,{})})})]})]})},Yn=h.div`
  display: flex;
  height: 60vh;
  display: flex;
  align-items: center;
...
`,nr=Se({password:Z().regex(/^(?=.*[a-zA-Z])(?=.*[0-9]).{8,25}$/," 영문,숫자조합 8자리 이상 입력해주세요.").optional(),contact:Z().nullable().optional(),birth:Z().trim().date("날짜 형식으로 입력해주세요."),gender:Z(),interests:Ne().array().min(1,"관심분야를 최소 하나 이상 선택해야 합니다.")}),rr=()=>{var z,S,H,v,x,w,$,_,P,M,V,T;const t=localStorage.getItem("token"),s=localStorage.getItem("user_id"),[a,n]=i.useState([]),l=Ke(),c={token:t,user_id:s},{data:p}=ct(c),r=Li(),{openToast:o}=we(),{register:f,handleSubmit:m,setValue:g,control:j,formState:{errors:d}}=me({resolver:He(nr)});i.useEffect(()=>{p&&(n(p.data.interests),g("password",p.data.password),g("contact",p.data.contact),g("birth",p.data.birth),g("gender",p.data.sex?"woman":"man"),g("interests",p.data.interests))},[p,g]);const u=L=>{Ct(L,g,"contact")},C=L=>{Nt(L,g,"birth")},N=(L,I)=>{const E=I?[...a,L]:a.filter(F=>F!==L);n(E),g("interests",E)},k=m(L=>{const I=()=>{if(L.gender==="man")return!1;if(L.gender==="woman")return!0},E={token:t,user_id:s,modifyData:{birth:L.birth,sex:I(),interests:L.interests}};L.contact&&(E.modifyData.contact=L.contact),L.password&&(E.modifyData.password=L.password),r.mutate(E,{onSuccess:()=>{o("저장 되었습니다.")},onError:F=>{console.log(F)}})});return e.jsx(tr,{children:p&&e.jsxs(e.Fragment,{children:[e.jsxs(ir,{children:[e.jsxs("div",{children:[e.jsx("span",{className:"label",children:"이름"}),e.jsx("span",{className:"info",children:p.data.name})]}),e.jsxs("div",{children:[e.jsx("span",{className:"label",children:"이메일(ID)"}),e.jsx("span",{className:"info",children:p.data.email})]})]}),e.jsxs(sr,{onSubmit:k,children:[e.jsxs("div",{className:"td_form",children:[e.jsx(kt,{label:"전화번호",type:"text",id:"contact",placeholder:"전화번호를 입력하세요",register:f,onChange:u}),((z=d.contact)==null?void 0:z.message)&&e.jsx("p",{className:"err_msg",children:(H=(S=d.contact)==null?void 0:S.message)==null?void 0:H.toString()})]}),e.jsxs("div",{className:"td_form",children:[e.jsx(kt,{label:"비밀번호 변경",type:"password",id:"password",placeholder:"비밀번호를 입력하세요",register:f}),((v=d.password)==null?void 0:v.message)&&e.jsx("p",{className:"err_msg",children:(w=(x=d.password)==null?void 0:x.message)==null?void 0:w.toString()})]}),e.jsxs("div",{className:"radio_box",children:[e.jsx("p",{className:"label",children:"성별"}),e.jsx(_e,{label:"남",id:"man",name:"gender",register:f}),e.jsx(_e,{label:"여",id:"woman",name:"gender",register:f})]}),e.jsxs("div",{className:"td_form",children:[e.jsx(kt,{label:"생년월일",type:"text",id:"birth",placeholder:"생년월일을 입력하세요",register:f,onChange:C}),(($=d.birth)==null?void 0:$.message)&&e.jsx("p",{className:"err_msg",children:(P=(_=d.birth)==null?void 0:_.message)==null?void 0:P.toString()})]}),e.jsxs("div",{className:"favorite_box",children:[e.jsx("p",{className:"label",children:"관심분야"}),e.jsx("div",{className:"favorite_list",children:e.jsx(Ce,{name:"interests",control:j,render:({field:L})=>{var I;return e.jsx(e.Fragment,{children:l&&L.value&&((I=l==null?void 0:l.data)==null?void 0:I.map(E=>e.jsx(Ae,{label:E.name,id:JSON.stringify(E.id),checked:a.includes(E.id),onChange:F=>{N(E.id,F.target.checked)}},E.id)))})}})}),((M=d.interests)==null?void 0:M.message)&&e.jsx("p",{className:"err_msg",children:(T=(V=d.interests)==null?void 0:V.message)==null?void 0:T.toString()})]}),e.jsxs(ar,{children:[e.jsx("button",{className:"submit_btn",children:"저장"}),e.jsx(b,{to:"/mypage/user-modify/with-draw",children:"마이스 메이트 탈퇴하기"})]})]})]})})},lr=h.div`
  padding: 20px 0 0;
  position: relative;
`,or=h.div`
...
`,Zi=({applyType:t,register:s,setValue:a,watch:n})=>{const l=["agree1","agree2","agree3","agree4"],p=n(l).every(Boolean),r=o=>{l.forEach(f=>a(f,o))};return i.useEffect(()=>{a("allAgree",p)},[p,a]),e.jsxs(bl,{children:[e.jsx("h3",{children:"신청 내용"}),e.jsxs("div",{className:"apply_desc",children:[e.jsxs("div",{className:"type",children:[e.jsx("span",{className:"tit",children:"신청 유형"}),e.jsx("span",{className:"info",children:t===0?"개인 신청":"단체 신청"})]}),e.jsxs("div",{className:"type",children:[e.jsx("span",{className:"tit",children:"신청 비용"}),e.jsx("span",{className:"info",children:"사전등록 무료"})]})]}),e.jsx("div",{className:"all_chk",children:e.jsx(Ae,{label:"전체 동의하기",id:"allChk",register:s,checked:p,onChange:o=>{const f=o.target;r(f.checked)}})}),e.jsxs("div",{className:"agree_list",children:[e.jsxs("div",{children:[e.jsx(Ae,{label:"(필수) 성별 생년 정보 제공 동의",id:"agree1",register:s}),e.jsx("p",{className:"link",children:e.jsx(b,{to:"/gender-birth-information",target:"blank_",children:"자세히 보기"})})]}),e.jsxs("div",{children:[e.jsx(Ae,{label:"(필수) 개인정보 수집 이용 동의",id:"agree2",register:s}),e.jsx("p",{className:"link",children:e.jsx(b,{to:"/personal-information",target:"blank_",children:"자세히 보기"})})]}),e.jsxs("div",{children:[e.jsx(Ae,{label:"(필수) 제 3자 제공 동의",id:"agree3",register:s}),e.jsx("p",{className:"link",children:e.jsx(b,{to:"/onward-transfer",target:"blank_",children:"자세히 보기"})})]}),e.jsxs("div",{children:[e.jsx(Ae,{label:"(선택) 마케팅 정보 수신 동의",id:"agree4",register:s}),e.jsx("p",{className:"link",children:e.jsx(b,{to:"/markeyting-information",target:"blank_",children:"자세히 보기"})})]})]}),e.jsx("div",{className:"submit_btn",children:e.jsx("button",{type:"submit",disabled:!(n("agree1")&&n("agree2")&&n("agree3")),children:"사전 신청하기"})})]})},$i=h.div``,Ii=h.form`
...
`,xo=h.header``,Wi="/assets/main_logo_w-BBqllR6y.png",Yi=()=>{const t=localStorage.getItem("token"),s=ke(he),a=je(he),{data:n,isError:l}=yi(t),c=D(),{openAlret:p}=Ee();return i.useEffect(()=>{n&&localStorage.setItem("user_type",n.data.is_company),l&&n===void 0&&(p({text:`토큰이 만료되어 로그아웃 되었습니다.
