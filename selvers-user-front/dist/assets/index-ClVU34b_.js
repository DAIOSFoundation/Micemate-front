...
`,kn=Se({email:T().email({message:"올바른 이메일을 입력해주세요."}),password:T(),remember:ee()}),Hn=()=>{var d,u,C,N;const[t,s]=i.useState(!1),a=ke(xe),n=ks(),l=D(),{register:c,handleSubmit:p,setError:r,watch:o,formState:{errors:f}}=he({resolver:He(kn)}),m=o("email"),g=o("password");i.useEffect(()=>{m!=null&&m.trim()&&(g==null?void 0:g.trim())!==void 0?s(!0):s(!1)},[m,g]);const w=p(k=>{const V={email:k.email,password:k.password,remember:k.remember};n.mutate(V)});return i.useEffect(()=>{n.isSuccess&&(a.data.is_company===!0?l("/host-main",{replace:!0}):l("/",{replace:!0}))},[n.isSuccess,l,a.data.is_company]),i.useEffect(()=>{var k,V,S;if(n.isError){const H=n.error;(S=(V=(k=H==null?void 0:H.response)==null?void 0:k.data)==null?void 0:V.data)!=null&&S.error?H.response.data.data.error==="Unauthorised"?r("apiError",{type:"manual",message:"이메일 또는 비밀번호를 확인해주세요."}):r("apiError",{type:"manual",message:H.response.data.data.error}):r("apiError",{type:"manual",message:"알 수 없는 오류가 발생했습니다."})}},[n.isError,n.error,r]),e.jsxs(_n,{children:[e.jsxs(jn,{children:[e.jsx("h2",{children:"LOGIN"}),e.jsx("span",{children:"즐거운 만남을 시작해보세요!"})]}),e.jsxs(wn,{onSubmit:w,children:[e.jsxs("div",{className:"input_box",children:[e.jsx(Et,{label:"이메일(ID)",type:"text",id:"email",placeholder:"이메일 입력",register:c}),e.jsx(Et,{label:"비밀번호",type:"password",id:"password",placeholder:"비밀번호 입력",register:c})]}),f.email&&e.jsx("p",{className:"err_msg",children:(u=(d=f.email)==null?void 0:d.message)==null?void 0:u.toString()}),f.apiError&&e.jsx("p",{className:"err_msg",children:(N=(C=f.apiError)==null?void 0:C.message)==null?void 0:N.toString()}),e.jsx("div",{className:"login_stay",children:e.jsx(Ve,{label:"로그인유지",id:"remember",register:c})}),e.jsx(vn,{disabled:!t,children:"로그인"})]}),e.jsxs(yn,{children:[e.jsx(b,{to:"/login/password-find",children:"비밀번호 찾기"}),"   |   ",e.jsx(b,{to:"/join",children:"회원가입"})]}),e.jsx(Cn,{}),e.jsx(Nn,{className:"desc_btn",children:e.jsx(b,{to:"/privacy-policy",children:"개인정보 처리방침"})})]})},Sn=h.div`
  width: 384px;
  margin: 0 auto 160px;
  @media (max-width: 1024px) {
    width: 100%;
...
`,Vn=Se({email:T().trim().min(1,"이메일을 입력해주세요.").email({message:"올바른 이메일을 입력해주세요."})}),An=()=>{var f,m,g,w,d,u;const t=ga(),{openAlret:s}=Ee(),a=D(),n={text:"메일로 임시 비밀번호를 발송했습니다.",callback:()=>{a("/login")}},{setError:l,register:c,handleSubmit:p,formState:{errors:r}}=he({resolver:He(Vn)}),o=p(C=>{t.mutate(C.email,{onSuccess:()=>{s(n)},onError:()=>{l("apiError",{type:"manual",message:"가입된 정보가 없습니다. 이메일을 확인해주세요."})}})});return e.jsxs(Sn,{children:[e.jsxs(En,{children:[e.jsx("h2",{children:"비밀번호 찾기"}),e.jsx("span",{children:"가입하신 이메일로 임시 비밀번호를 전송해드립니다."})]}),e.jsxs(Ln,{onSubmit:o,children:[e.jsx(Et,{label:"이메일(ID)",type:"text",id:"email",placeholder:"이메일 입력",register:c}),((f=r.email)==null?void 0:f.message)&&e.jsx("p",{className:"err_msg",children:(g=(m=r.email)==null?void 0:m.message)==null?void 0:g.toString()}),((w=r.apiError)==null?void 0:w.message)&&e.jsx("p",{className:"err_msg",children:(u=(d=r.apiError)==null?void 0:d.message)==null?void 0:u.toString()}),e.jsx(zn,{children:"임시 비밀번호 받기"})]})]})},Mn=h.div`
  padding: 0 0 97px;
  color: #fff;
  @media (max-width: 1024px) {
    padding: 0 0 58px;
...
`,nr=Se({password:T().regex(/^(?=.*[a-zA-Z])(?=.*[0-9]).{8,25}$/," 영문,숫자조합 8자리 이상 입력해주세요.").optional(),contact:T().nullable().optional(),birth:T().trim().date("날짜 형식으로 입력해주세요."),gender:T(),interests:Ne().array().min(1,"관심분야를 최소 하나 이상 선택해야 합니다.")}),rr=()=>{var V,S,H,v,x,j,P,_,F,A,z,Z;const t=localStorage.getItem("token"),s=localStorage.getItem("user_id"),[a,n]=i.useState([]),l=Ke(),c={token:t,user_id:s},{data:p}=ct(c),r=Li(),{openToast:o}=we(),{register:f,handleSubmit:m,setValue:g,control:w,formState:{errors:d}}=he({resolver:He(nr)});i.useEffect(()=>{p&&(n(p.data.interests),g("password",p.data.password),g("contact",p.data.contact),g("birth",p.data.birth),g("gender",p.data.sex?"woman":"man"),g("interests",p.data.interests))},[p,g]);const u=L=>{Ct(L,g,"contact")},C=L=>{Nt(L,g,"birth")},N=(L,I)=>{const E=I?[...a,L]:a.filter(B=>B!==L);n(E),g("interests",E)},k=m(L=>{const I=()=>{if(L.gender==="man")return!1;if(L.gender==="woman")return!0},E={token:t,user_id:s,modifyData:{birth:L.birth,sex:I(),interests:L.interests}};L.contact&&(E.modifyData.contact=L.contact),L.password&&(E.modifyData.password=L.password),r.mutate(E,{onSuccess:()=>{o("저장 되었습니다.")},onError:B=>{console.log(B)}})});return e.jsx(tr,{children:p&&e.jsxs(e.Fragment,{children:[e.jsxs(ir,{children:[e.jsxs("div",{children:[e.jsx("span",{className:"label",children:"이름"}),e.jsx("span",{className:"info",children:p.data.name})]}),e.jsxs("div",{children:[e.jsx("span",{className:"label",children:"이메일(ID)"}),e.jsx("span",{className:"info",children:p.data.email})]})]}),e.jsxs(sr,{onSubmit:k,children:[e.jsxs("div",{className:"td_form",children:[e.jsx(kt,{label:"전화번호",type:"text",id:"contact",placeholder:"전화번호를 입력하세요",register:f,onChange:u}),((V=d.contact)==null?void 0:V.message)&&e.jsx("p",{className:"err_msg",children:(H=(S=d.contact)==null?void 0:S.message)==null?void 0:H.toString()})]}),e.jsxs("div",{className:"td_form",children:[e.jsx(kt,{label:"비밀번호 변경",type:"password",id:"password",placeholder:"비밀번호를 입력하세요",register:f}),((v=d.password)==null?void 0:v.message)&&e.jsx("p",{className:"err_msg",children:(j=(x=d.password)==null?void 0:x.message)==null?void 0:j.toString()})]}),e.jsxs("div",{className:"radio_box",children:[e.jsx("p",{className:"label",children:"성별"}),e.jsx(_e,{label:"남",id:"man",name:"gender",register:f}),e.jsx(_e,{label:"여",id:"woman",name:"gender",register:f})]}),e.jsxs("div",{className:"td_form",children:[e.jsx(kt,{label:"생년월일",type:"text",id:"birth",placeholder:"생년월일을 입력하세요",register:f,onChange:C}),((P=d.birth)==null?void 0:P.message)&&e.jsx("p",{className:"err_msg",children:(F=(_=d.birth)==null?void 0:_.message)==null?void 0:F.toString()})]}),e.jsxs("div",{className:"favorite_box",children:[e.jsx("p",{className:"label",children:"관심분야"}),e.jsx("div",{className:"favorite_list",children:e.jsx(Ce,{name:"interests",control:w,render:({field:L})=>{var I;return e.jsx(e.Fragment,{children:l&&L.value&&((I=l==null?void 0:l.data)==null?void 0:I.map(E=>e.jsx(Ve,{label:E.name,id:JSON.stringify(E.id),checked:a.includes(E.id),onChange:B=>{N(E.id,B.target.checked)}},E.id)))})}})}),((A=d.interests)==null?void 0:A.message)&&e.jsx("p",{className:"err_msg",children:(Z=(z=d.interests)==null?void 0:z.message)==null?void 0:Z.toString()})]}),e.jsxs(ar,{children:[e.jsx("button",{className:"submit_btn",children:"저장"}),e.jsx(b,{to:"/mypage/user-modify/with-draw",children:"마이스 메이트 탈퇴하기"})]})]})]})})},lr=h.div`
  padding: 20px 0 0;
  position: relative;
`,or=h.div`
...
`,Pi=({applyType:t,register:s,setValue:a,watch:n})=>{const l=["agree1","agree2","agree3","agree4"],p=n(l).every(Boolean),r=o=>{l.forEach(f=>a(f,o))};return i.useEffect(()=>{a("allAgree",p)},[p,a]),e.jsxs(bl,{children:[e.jsx("h3",{children:"신청 내용"}),e.jsxs("div",{className:"apply_desc",children:[e.jsxs("div",{className:"type",children:[e.jsx("span",{className:"tit",children:"신청 유형"}),e.jsx("span",{className:"info",children:t===0?"개인 신청":"단체 신청"})]}),e.jsxs("div",{className:"type",children:[e.jsx("span",{className:"tit",children:"신청 비용"}),e.jsx("span",{className:"info",children:"사전등록 무료"})]})]}),e.jsx("div",{className:"all_chk",children:e.jsx(Ve,{label:"전체 동의하기",id:"allChk",register:s,checked:p,onChange:o=>{const f=o.target;r(f.checked)}})}),e.jsxs("div",{className:"agree_list",children:[e.jsxs("div",{children:[e.jsx(Ve,{label:"(필수) 성별 생년 정보 제공 동의",id:"agree1",register:s}),e.jsx("p",{className:"link",children:e.jsx(b,{to:"/gender-birth-information",target:"blank_",children:"자세히 보기"})})]}),e.jsxs("div",{children:[e.jsx(Ve,{label:"(필수) 개인정보 수집 이용 동의",id:"agree2",register:s}),e.jsx("p",{className:"link",children:e.jsx(b,{to:"/personal-information",target:"blank_",children:"자세히 보기"})})]}),e.jsxs("div",{children:[e.jsx(Ve,{label:"(필수) 제 3자 제공 동의",id:"agree3",register:s}),e.jsx("p",{className:"link",children:e.jsx(b,{to:"/onward-transfer",target:"blank_",children:"자세히 보기"})})]}),e.jsxs("div",{children:[e.jsx(Ve,{label:"(선택) 마케팅 정보 수신 동의",id:"agree4",register:s}),e.jsx("p",{className:"link",children:e.jsx(b,{to:"/markeyting-information",target:"blank_",children:"자세히 보기"})})]})]}),e.jsx("div",{className:"submit_btn",children:e.jsx("button",{type:"submit",disabled:!(n("agree1")&&n("agree2")&&n("agree3")),children:"사전 신청하기"})})]})},Zi=h.div``,Ii=h.form`
...
`,$l=({boothList:t,selectList:s,setSelectList:a})=>{const[n,l]=i.useState(),c=r=>{s.includes(r)?(l(void 0),a(o=>o.filter(f=>f!==r))):(l(r),a(o=>[...o,r]))},p=r=>{const o=s.indexOf(r);return o!==-1?o+1:""};return e.jsx(Fl,{children:t&&t.map(r=>{let o="";return n===r.id?o="target":s.includes(r.id)?o="outline":o="",e.jsxs(Bl,{onClick:()=>c(r.id),className:o,children:[e.jsx("span",{className:"num",children:p(r.id)}),e.jsx("p",{className:"title",children:r.position}),e.jsx("figure",{children:r.image?e.jsx("img",{src:r.image,alt:r.name}):e.jsx("span",{className:"name",children:r.name})}),e.jsx(b,{to:r.url,target:"_blank",children:"홈페이지 바로가기"})]},r.id)})})},Tl=()=>{var N;const[t,s]=i.useState(!0),a=localStorage.getItem("token"),n=localStorage.getItem("user_id"),{id:l}=le(),{data:c,isLoading:p}=$t(l,a),[r,o]=i.useState([]),f=fa(),m=D(),{openToast:g}=we(),d=((k,V)=>{const S=[];for(let H=0;H<(k==null?void 0:k.length);H+=V)S.push(k.slice(H,H+V));return S})((N=c==null?void 0:c.data)==null?void 0:N.items,21),u=()=>{s(k=>!k)},C=()=>{r.length>=5?f.mutate({token:a,user_id:n,boothList:r},{onSuccess:()=>{m(`/mypage/apply-list/booth-check/${l}`,{replace:!0})}}):g("다섯개 이상 선택해주세요.")};return p?e.jsx(ve,{}):e.jsxs(Sl,{children:[e.jsxs(El,{children:[e.jsxs(Ll,{children:[e.jsx("span",{className:"main_title",children:"AI 추천 부스"}),e.jsx("button",{onClick:u,className:"offset_btn",children:e.jsx($i,{})}),t&&e.jsxs(zl,{children:[e.jsx("span",{className:"tit",children:"AI 추천 부스 서비스 이용방법"}),e.jsx("span",{children:"· 기업은 순위대로 5개 이상 골라주셔야 좀 더 정확한 추천이 가능해요."}),e.jsx("span",{children:"· 참가기업에 대한 자세한 정보는 웹페이지를 참고해주세요."})]})]}),e.jsx(Vl,{children:"몇 가지 정보만 알려주시면 평균 5개 이상의 추천부스를 받을 수 있어요!"})]}),e.jsx(Al,{children:e.jsx(vt,{slidesPerView:1,navigation:!0,modules:[At],spaceBetween:15,loop:!0,breakpoints:{1400:{spaceBetween:10},1700:{spaceBetween:22}},className:"booth_list_swiper",children:d.map((k,V)=>e.jsx(yt,{children:e.jsx($l,{boothList:k,selectList:r,setSelectList:o})},V))})}),e.jsx(Ml,{children:e.jsx("button",{onClick:C,children:"다음"})})]})},Pl=h.div`
  position: relative;
