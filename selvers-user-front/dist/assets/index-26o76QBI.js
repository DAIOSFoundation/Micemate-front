...
`,Ce=()=>{const[t,i]=Ot(Ws),s=n.useCallback(()=>{i({isOpen:!1,text:""})},[]),a=n.useCallback(r=>{i({isOpen:!0,text:r});const l=setTimeout(()=>{s()},3e3);return()=>clearTimeout(l)},[s]);return{toastData:t,openToast:a,closeToast:s}},Dr=Ye({password:Q().regex(/^(?=.*[a-zA-Z])(?=.*[0-9]).{8,25}$/," 영문,숫자조합 8자리 이상 입력해주세요.").optional(),contact:Q().nullable().optional(),birth:Q().trim().date("날짜 형식으로 입력해주세요."),gender:Q(),interests:qe().array().min(1,"관심분야를 최소 하나 이상 선택해야 합니다.")}),$r=()=>{var F,M,B,O,h,N,z,E,C,q,y,S;const t=localStorage.getItem("token"),i=localStorage.getItem("user_id"),[s,a]=n.useState([]),r=$e(),l={token:t,user_id:i},{data:c}=jt(l),o=Oi(),{openToast:d}=Ce(),{register:p,handleSubmit:f,setValue:g,control:x,formState:{errors:m}}=ve({resolver:Pe(Dr)});n.useEffect(()=>{c&&(a(c.data.interests),g("password",c.data.password),g("contact",c.data.contact),g("birth",c.data.birth),g("gender",c.data.sex?"woman":"man"),g("interests",c.data.interests))},[c,g]);const b=_=>{_t(_,g,"contact")},j=_=>{Ft(_,g,"birth")},w=(_,k)=>{const v=k?[...s,_]:s.filter(T=>T!==_);a(v),g("interests",v)},A=f(_=>{const k=()=>{if(_.gender==="man")return!1;if(_.gender==="woman")return!0},v={token:t,user_id:i,modifyData:{birth:_.birth,sex:k(),interests:_.interests}};_.contact&&(v.modifyData.contact=_.contact),_.password&&(v.modifyData.password=_.password),o.mutate(v,{onSuccess:()=>{d("저장 되었습니다.")},onError:T=>{console.log(T)}})});return e.jsx(Jr,{children:c&&e.jsxs(e.Fragment,{children:[e.jsxs(Kr,{children:[e.jsxs("div",{children:[e.jsx("span",{className:"label",children:"이름"}),e.jsx("span",{className:"info",children:c.data.name})]}),e.jsxs("div",{children:[e.jsx("span",{className:"label",children:"이메일(ID)"}),e.jsx("span",{className:"info",children:c.data.email})]})]}),e.jsxs(Gr,{onSubmit:A,children:[e.jsxs("div",{className:"td_form",children:[e.jsx(Vt,{label:"전화번호",type:"text",id:"contact",placeholder:"전화번호를 입력하세요",register:p,onChange:b}),((F=m.contact)==null?void 0:F.message)&&e.jsx("p",{className:"err_msg",children:(B=(M=m.contact)==null?void 0:M.message)==null?void 0:B.toString()})]}),e.jsxs("div",{className:"td_form",children:[e.jsx(Vt,{label:"비밀번호 변경",type:"password",id:"password",placeholder:"비밀번호를 입력하세요",register:p}),((O=m.password)==null?void 0:O.message)&&e.jsx("p",{className:"err_msg",children:(N=(h=m.password)==null?void 0:h.message)==null?void 0:N.toString()})]}),e.jsxs("div",{className:"radio_box",children:[e.jsx("p",{className:"label",children:"성별"}),e.jsx(It,{label:"남",id:"man",name:"gender",register:p}),e.jsx(It,{label:"여",id:"woman",name:"gender",register:p})]}),e.jsxs("div",{className:"td_form",children:[e.jsx(Vt,{label:"생년월일",type:"text",id:"birth",placeholder:"생년월일을 입력하세요",register:p,onChange:j}),((z=m.birth)==null?void 0:z.message)&&e.jsx("p",{className:"err_msg",children:(C=(E=m.birth)==null?void 0:E.message)==null?void 0:C.toString()})]}),e.jsxs("div",{className:"favorite_box",children:[e.jsx("p",{className:"label",children:"관심분야"}),e.jsx("div",{className:"favorite_list",children:e.jsx(Ze,{name:"interests",control:x,render:({field:_})=>{var k;return e.jsx(e.Fragment,{children:r&&_.value&&((k=r==null?void 0:r.data)==null?void 0:k.map(v=>e.jsx(Ae,{label:v.name,id:JSON.stringify(v.id),checked:s.includes(v.id),onChange:T=>{w(v.id,T.target.checked)}},v.id)))})}})}),((q=m.interests)==null?void 0:q.message)&&e.jsx("p",{className:"err_msg",children:(S=(y=m.interests)==null?void 0:y.message)==null?void 0:S.toString()})]}),e.jsxs(Xr,{children:[e.jsx("button",{className:"submit_btn",children:"저장"}),e.jsx(H,{to:"/mypage/user-modify/with-draw",children:"마이스 메이트 탈퇴하기"})]})]})]})})},eo=u.div`
  padding: 20px 0 0;
  position: relative;
`,to=u.div`
