...
`,Ci=t=>i.createElement("svg",{width:14,height:14,viewBox:"0 0 14 14",fill:"none",xmlns:"http://www.w3.org/2000/svg",...t},i.createElement("path",{d:"M1 1L13 13",stroke:"#555555",strokeLinecap:"round",strokeLinejoin:"round"}),i.createElement("path",{d:"M13 1L0.999999 13",stroke:"#555555",strokeLinecap:"round",strokeLinejoin:"round"})),Ni=()=>{const{alretData:t,closeAlret:s}=Ee();return e.jsx(e.Fragment,{children:t.isOpen&&e.jsx($s,{children:e.jsxs(Zs,{children:[e.jsx("div",{className:"alret_header",children:e.jsx("button",{onClick:s,className:"close_btn",children:e.jsx(Ci,{})})}),e.jsx("div",{className:"desc",children:t.text}),e.jsx("div",{className:"btn_area",children:e.jsx("button",{onClick:s,className:"primary",children:"확인"})})]})})})},Is=h.div`
  position: fixed;
  top: 0;
  right: 0;
  bottom: 0;
...
`,Wn=({id:t,title:s,img:a,event_start_date:n,event_end_date:l,position:c,date:p,is_booth:r,liked_booth:o,url:f,eventState:m})=>{const g=Ha(),w=Ft(),d=localStorage.getItem("token"),u=localStorage.getItem("user_id"),{openAlret:C}=Ee(),{openConfirm:N,confirmValue:k}=Ye(),V=Vt(),[S,H]=i.useState(!1),[v,x]=i.useState(""),j=je(Ae),[$,_]=i.useState(!0);i.useEffect(()=>{H(k.confirm)},[k.confirm]),i.useEffect(()=>{if(S===!0&&v.length>0){const z={token:d,event_id:v};g.mutate(z)}},[S]);const F=z=>{N({text:"취소하시겠습니까? 취소 확정 후에는 복구하실 수 없습니다.",okBtn:"취소하기",logout:!1}),x(z)};i.useEffect(()=>{if(g.isSuccess){const z={text:"취소가 완료되었습니다."};H(!1),j(),x(""),C(z),V.invalidateQueries({queryKey:["myEvent"]})}g.isError&&(H(!1),x(""))},[g.isSuccess,g.isError]);const A=z=>{const Z={token:d,user_id:u,event_id:z};w.mutate(Z),_(L=>!L)};return e.jsxs(Pn,{children:[e.jsx($n,{children:e.jsxs(b,{to:`/detail/${t}`,children:[m.state==="cancel"&&e.jsx("span",{className:"blind",children:"취소완료"}),e.jsx("img",{src:`https://api.micemate.io/storage/${a}`})]})}),e.jsxs(Zn,{children:[e.jsxs(In,{children:[p&&e.jsxs("div",{className:"apply",children:[e.jsx("span",{className:"state",children:m.label}),e.jsxs("span",{className:"date",children:["신청일 : ",p]})]}),e.jsxs("div",{className:"txt_box",children:[e.jsx("span",{className:"title",children:s}),e.jsx("span",{className:"date",children:`${ft(n)} ~ ${ft(l)}`}),e.jsx("span",{className:"location",children:c})]})]}),m.state==="apply"&&e.jsxs(On,{children:[e.jsx(b,{to:`/detail/${t}/apply/edit`,children:"수정"}),"  |  ",e.jsx("button",{onClick:()=>F(JSON.stringify(t)),children:"취소"})]}),m.state==="apply"&&e.jsxs(qn,{children:[r&&o&&e.jsx(b,{to:`/mypage/apply-list/booth-check/${t}`,children:"AI 추천 부스 보기"}),r&&!o&&e.jsx(b,{to:`/mypage/apply-list/booth-select/${t}`,children:"AI 추천 부스 받기"}),f&&e.jsx(b,{to:f,target:"_blank",children:"행사 접속하기"})]}),m.state==="wish"&&e.jsx(Rn,{children:e.jsx("button",{onClick:()=>A(t),children:$?e.jsx(Si,{}):e.jsx(Ei,{})})})]})]})},Yn=h.div`
  display: flex;
  height: 60vh;
  display: flex;
  align-items: center;
...
`,$i=({applyType:t,register:s,setValue:a,watch:n})=>{const l=["agree1","agree2","agree3","agree4"],p=n(l).every(Boolean),r=o=>{l.forEach(f=>a(f,o))};return i.useEffect(()=>{a("allAgree",p)},[p,a]),e.jsxs(bl,{children:[e.jsx("h3",{children:"신청 내용"}),e.jsxs("div",{className:"apply_desc",children:[e.jsxs("div",{className:"type",children:[e.jsx("span",{className:"tit",children:"신청 유형"}),e.jsx("span",{className:"info",children:t===0?"개인 신청":"단체 신청"})]}),e.jsxs("div",{className:"type",children:[e.jsx("span",{className:"tit",children:"신청 비용"}),e.jsx("span",{className:"info",children:"사전등록 무료"})]})]}),e.jsx("div",{className:"all_chk",children:e.jsx(Ve,{label:"전체 동의하기",id:"allChk",register:s,checked:p,onChange:o=>{const f=o.target;r(f.checked)}})}),e.jsxs("div",{className:"agree_list",children:[e.jsxs("div",{children:[e.jsx(Ve,{label:"(필수) 성별 생년 정보 제공 동의",id:"agree1",register:s}),e.jsx("p",{className:"link",children:e.jsx(b,{to:"/gender-birth-information",target:"blank_",children:"자세히 보기"})})]}),e.jsxs("div",{children:[e.jsx(Ve,{label:"(필수) 개인정보 수집 이용 동의",id:"agree2",register:s}),e.jsx("p",{className:"link",children:e.jsx(b,{to:"/personal-information",target:"blank_",children:"자세히 보기"})})]}),e.jsxs("div",{children:[e.jsx(Ve,{label:"(필수) 제 3자 제공 동의",id:"agree3",register:s}),e.jsx("p",{className:"link",children:e.jsx(b,{to:"/onward-transfer",target:"blank_",children:"자세히 보기"})})]}),e.jsxs("div",{children:[e.jsx(Ve,{label:"(선택) 마케팅 정보 수신 동의",id:"agree4",register:s}),e.jsx("p",{className:"link",children:e.jsx(b,{to:"/markeyting-information",target:"blank_",children:"자세히 보기"})})]})]}),e.jsx("div",{className:"submit_btn",children:e.jsx("button",{type:"submit",disabled:!(n("agree1")&&n("agree2")&&n("agree3")),children:"사전 신청하기"})})]})},Zi=h.div``,Ii=h.form`
