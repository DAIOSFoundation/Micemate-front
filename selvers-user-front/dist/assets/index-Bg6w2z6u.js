...
`,zi=t=>n.createElement("svg",{width:16,height:16,viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg",...t},n.createElement("rect",{x:1.52344,width:20.4717,height:2.15492,rx:1,transform:"rotate(45 1.52344 0)",fill:"white"}),n.createElement("rect",{x:16,y:1.52344,width:20.4717,height:2.15492,rx:1,transform:"rotate(135 16 1.52344)",fill:"white"})),fi=({children:t,setClose:i})=>{const a=Be(je).isLogin,r=localStorage.getItem("name"),d=()=>{i(!1),document.body.style.overflow="auto"};return e.jsxs(Is,{children:[e.jsxs(Os,{children:[a&&e.jsx("div",{className:"user_name",children:`${JSON.parse(r)} 님`}),e.jsx("button",{onClick:()=>d(),className:"close_btn",children:e.jsx(zi,{})})]}),e.jsx(Zs,{children:t})]})},qs=b.header`
...
`,Rt=({label:t,type:i,id:s,placeholder:a,register:r})=>e.jsxs(Ba,{children:[e.jsx("label",{children:t}),e.jsx("input",{type:i,id:s,...r&&r(s),placeholder:a,autoComplete:"off"})]}),ht=({type:t,id:i,register:s,placeholder:a,onChange:r})=>e.jsx(Ra,{type:t,id:i,...s&&s(i),placeholder:a,autoComplete:"off",onChange:r}),Vt=({label:t,type:i,id:s,placeholder:a,register:r,onChange:d})=>e.jsxs(Ia,{className:"InputTextC",children:[e.jsx("label",{htmlFor:s,children:t}),e.jsx("input",{type:i,id:s,...r&&r(s),placeholder:a,autoComplete:"off",onChange:d})]}),Ie=({label:t,type:i,id:s,register:a,required:r,onChange:d})=>e.jsxs(Oa,{children:[e.jsxs("label",{htmlFor:s,className:"label",children:[e.jsx("span",{className:"txt",children:t}),r&&e.jsx("span",{className:"req",children:" *"})]}),e.jsx("div",{className:"input_area",children:e.jsx("input",{type:i,id:s,autoComplete:"off",...a&&a(s),className:"input",onChange:d})})]}),Za=b.div`
  width: 100%;
  & input {
    display: none;
  }
...
`,rr=t=>{const i={email:Y().trim().min(1,"아이디를 입력해주세요.").email({message:"올바른 이메일을 입력해주세요."}),password:t===!1?Y().trim().min(1,"비밀번호를 입력해주세요.").regex(/^(?=.*[a-zA-Z])(?=.*[0-9]).{8,25}$/," 영문,숫자조합 8자리 이상 입력해주세요."):Y().optional(),passwordChk:t===!1?Y():Y().optional(),name:Y().trim().min(1,"이름을 입력해주세요.").min(2,"이름을 확인해주세요."),birth:Y().trim().min(1,"생년월일을 입력해주세요.").regex(/^\d{4}-\d{2}-\d{2}$/,"올바른 날짜 형식으로 입력해주세요.").refine(s=>{const a=new Date(s);return!isNaN(a.getTime())},"유효한 날짜를 입력해주세요."),gender:Y({message:"성별을 선택해주세요."}),interests:Ze().array().min(1,"관심분야를 최소 하나 이상 선택해야 합니다."),allChk:xe().default(!1).optional(),agree_01:xe(),agree_02:xe().default(!1).optional(),agree_03:xe(),agree_04:xe()};return Pe({...i}).superRefine(({passwordChk:s,password:a},r)=>{s!==a&&r.addIssue({code:Hs.custom,message:"비밀번호를 확인해주세요.",path:["passwordChk"]})})},or=()=>{var Z,J,q,W,P,G,T,K,ce,ue,me,be,Ne,Ve,Te,I,ee,re,Se,we,Re,Qe;const[t,i]=n.useState([]),[s,a]=n.useState([]),[r,d]=n.useState(!1),[c,o]=n.useState(!1),l=xn(),p=hn(),{openAlret:f}=ze(),g=$(),x=rr(c),[m,u]=n.useState(null),[w,_]=n.useState(null);n.useEffect(()=>{u(localStorage.getItem("social_email")),_(localStorage.getItem("social_name"))},[]),console.log(c);const{data:H}=$e(),{register:L,handleSubmit:z,setValue:B,control:O,watch:h,setError:C,formState:{errors:S}}=ve({resolver:qe(x)}),j=M=>{let Q=M.target.value.replace(/\D/g,"");Q.length>4&&Q.length<=6?Q=Q.slice(0,4)+"-"+Q.slice(4):Q.length>6&&(Q=Q.slice(0,4)+"-"+Q.slice(4,6)+"-"+Q.slice(6,8)),B("birth",Q)},N=M=>{i(Q=>Q.filter(le=>le!==M)),a(Q=>Q.filter(le=>le.id!==M)),B("interests",t.filter(Q=>Q!==M)),B(`checkbox-${M}`,!1)},V=(M,Q)=>{const le=M.target,oe=le.value;le.checked?(i(pe=>[...pe,Q]),a(pe=>[...pe,{id:Q,name:oe}])):(i(pe=>pe.filter(Le=>Le!==Q)),a(pe=>pe.filter(Le=>Le.id!==Q)))};n.useEffect(()=>{B("interests",t)},[t,B,s]);const y=h("allChk"),A=h("agree_01"),v=h("agree_03"),R=h("agree_04");n.useEffect(()=>{const M=["agree_01","agree_02","agree_03","agree_04"];y===!0?M.forEach(Q=>B(Q,!0)):M.forEach(Q=>B(Q,!1))},[y,B]),n.useEffect(()=>{d(!!(A&&v&&R))},[A,v,R]),n.useEffect(()=>{m!==null&&w!==null&&(o(!0),B("email",m),B("name",w))},[m,w]);const k=z(M=>{m!==null&&w!==null&&(localStorage.removeItem("social_token"),localStorage.removeItem("social_email"),localStorage.removeItem("social_name"));const Q=()=>{if(M.gender==="man")return!1;if(M.gender==="woman")return!0};if(c){const le=localStorage.getItem("social_provider"),oe=localStorage.getItem("social_provider_id"),Ce={provider:le,provider_id:oe,password:M.password,c_password:M.passwordChk,birth:M.birth,sex:Q(),interests:t,terms_of_uses:{1:M.agree_01,2:M.agree_02,3:M.agree_03,4:M.agree_04}};p.mutate(Ce,{onSuccess:()=>{f({text:"간편 회원가입이 완료되었습니다.",callback:()=>{g("/login",{replace:!0})}})},onError:pe=>{var We;const Le=pe;console.log(Le.response.data),((We=Le.response)==null?void 0:We.data.message)==="이미 회원이 존재합니다."&&C("apiError",{type:"manual",message:"사용중인 이메일 입니다."})}})}if(!c){const le={name:M.name,email:M.email,password:M.password,c_password:M.passwordChk,birth:M.birth,sex:Q(),interests:t,terms_of_uses:{1:M.agree_01,2:M.agree_02,3:M.agree_03,4:M.agree_04}};l.mutate(le,{onSuccess:()=>{f({text:`회원가입이 완료되었습니다.
이메일 인증 후 서비스를 이용할 수 있습니다.`,callback:()=>{g("/login",{replace:!0})}})},onError:oe=>{var pe;const Ce=oe;console.log(Ce.response.data),((pe=Ce.response)==null?void 0:pe.data.message)==="이미 회원이 존재합니다."&&C("apiError",{type:"manual",message:"사용중인 이메일 입니다."})}})}});return l.isPending?e.jsx(Ae,{}):e.jsx(er,{children:e.jsxs(tr,{onSubmit:k,children:[e.jsx(mt,{children:e.jsx(ht,{type:"text",id:"email",register:L,placeholder:"이메일(ID)"})}),((Z=S.email)==null?void 0:Z.message)&&e.jsx("p",{className:"err_msg",children:(q=(J=S.email)==null?void 0:J.message)==null?void 0:q.toString()}),c===!1&&e.jsxs(e.Fragment,{children:[e.jsxs(mt,{className:"password",children:[e.jsx(ht,{type:"password",id:"password",register:L,placeholder:"비밀번호"}),e.jsx(ht,{type:"password",id:"passwordChk",register:L,placeholder:"비밀번호 확인"})]}),((W=S.password)==null?void 0:W.message)&&e.jsx("p",{className:"err_msg",children:(G=(P=S.password)==null?void 0:P.message)==null?void 0:G.toString()}),((T=S.passwordChk)==null?void 0:T.message)&&e.jsx("p",{className:"err_msg",children:(ce=(K=S.passwordChk)==null?void 0:K.message)==null?void 0:ce.toString()})]}),e.jsx(mt,{children:e.jsx(ht,{type:"text",id:"name",register:L,placeholder:"이름"})}),((ue=S.name)==null?void 0:ue.message)&&e.jsx("p",{className:"err_msg",children:(be=(me=S.name)==null?void 0:me.message)==null?void 0:be.toString()}),e.jsxs(mt,{children:[e.jsx(ht,{id:"birth",register:L,placeholder:"생년월일 8자리",onChange:j}),e.jsxs(ir,{children:[e.jsx(_i,{id:"man",label:"남",name:"gender",register:L}),e.jsx(_i,{id:"woman",label:"여",name:"gender",register:L})]})]}),((Ne=S.birth)==null?void 0:Ne.message)&&e.jsx("p",{className:"err_msg",children:(Te=(Ve=S.birth)==null?void 0:Ve.message)==null?void 0:Te.toString()}),((I=S.gender)==null?void 0:I.message)&&e.jsx("p",{className:"err_msg",children:(re=(ee=S.gender)==null?void 0:ee.message)==null?void 0:re.toString()}),e.jsx(mt,{children:e.jsx(Ka,{text:"관심 분야",children:e.jsx(sr,{children:e.jsx(Oe,{name:"interests",control:O,render:({field:M})=>e.jsx(e.Fragment,{children:H&&M&&H.map(Q=>e.jsx(et,{label:Q.name,id:`checkbox-${Q.id}`,onChange:le=>{V(le,Q.id)},register:L},Q.id))})})})})}),s.length>=1&&e.jsx($a,{hashList:s,onClick:N}),S.interests&&e.jsx("p",{className:"err_msg",children:(we=(Se=S.interests)==null?void 0:Se.message)==null?void 0:we.toString()}),e.jsxs(nr,{children:[e.jsx(et,{label:"선택 포함 전체 약관 동의",id:"allChk",register:L}),e.jsxs("div",{children:[e.jsxs("div",{className:"required_box",children:[e.jsx(et,{label:"이용약관 동의 (필수)",id:"agree_01",register:L}),e.jsx("p",{className:"link",children:e.jsx(E,{to:"/terms-service",target:"blank_",children:"약관 보기"})})]}),e.jsx(et,{label:"이벤트 혜택 알림 수신 동의 (선택)",id:"agree_02",register:L}),e.jsxs("div",{className:"required_box",children:[e.jsx(et,{label:"성별, 생년 정보 제공 동의 (필수)",id:"agree_03",register:L}),e.jsx("p",{className:"link",children:e.jsx(E,{to:"/gender-birth-information",target:"blank_",children:"내용 확인"})})]}),e.jsxs("div",{className:"required_box",children:[e.jsx(et,{label:"개인 정보 수집 및 이용 동의 (필수)",id:"agree_04",register:L}),e.jsx("p",{className:"link",children:e.jsx(E,{to:"/personal-information",target:"blank_",children:"내용 확인"})})]})]})]}),S.apiError&&e.jsx("p",{className:"err_msg",children:(Qe=(Re=S.apiError)==null?void 0:Re.message)==null?void 0:Qe.toString()}),e.jsx(ar,{disabled:!r,className:"btn",children:"회원가입"})]})})},lr=()=>{const i=new URLSearchParams(fe().search),s=$(),{openAlret:a}=ze(),r=JSON.parse(i.get("state")),d=i.get("provider"),c=i.get("provider-id"),o=i.get("email"),l=i.get("name"),p=i.get("access-token"),f=i.get("error");return n.useLayoutEffect(()=>{r===!0&&d&&c&&o&&l?(localStorage.setItem("social_provider",d),localStorage.setItem("social_provider_id",c),localStorage.setItem("social_email",o),localStorage.setItem("social_name",l)):r===!0&&p?localStorage.setItem("social_token",p):r===!1&&f==="deleted_user"?a({text:"탈퇴한 회원입니다.",callback:()=>{s("/",{replace:!0})}}):r===!1&&a({text:"로그인에 실패했습니다. 다시 시도해 주세요.",callback:()=>{s("/login",{replace:!0})}})},[]),n.useEffect(()=>{const g=localStorage.getItem("social_provider"),x=localStorage.getItem("social_provider_id"),m=localStorage.getItem("social_email"),u=localStorage.getItem("social_name"),w=localStorage.getItem("social_token");g!==null&&x!==null&&m!==null&&u!==null?s("/join/form"):w!==null&&s("/social-token-valid")},[]),e.jsx(Ae,{})},dr=()=>{const t=Ci(je),i=Be(je),s=$(),a=localStorage.getItem("social_token"),{data:r,isSuccess:d}=zt(a);return n.useEffect(()=>{if(r){const c={isLogin:!0,isLoginError:!1,data:{user_id:r.data.user_id,name:r.data.name,token:a,is_company:r.data.is_company}};t({...c})}},[r]),n.useEffect(()=>{d&&(i.data.is_company===!0?s("/host-main",{replace:!0}):s("/",{replace:!0}),localStorage.removeItem("social_provider"),localStorage.removeItem("social_provider_id"),localStorage.removeItem("social_token"))},[d]),e.jsx(Ae,{})},cr=b.div`
  @media (max-width: 1024px) {
    padding: 0 16px;
  }
`,pr=b.div`
...
`,ke=()=>{const[t,i]=Ot(Js),s=n.useCallback(()=>{i({isOpen:!1,text:""})},[]),a=n.useCallback(r=>{i({isOpen:!0,text:r});const d=setTimeout(()=>{s()},3e3);return()=>clearTimeout(d)},[s]);return{toastData:t,openToast:a,closeToast:s}},$r=Pe({password:Y().regex(/^(?=.*[a-zA-Z])(?=.*[0-9]).{8,25}$/," 영문,숫자조합 8자리 이상 입력해주세요.").optional(),contact:Y().nullable().optional(),birth:Y().trim().date("날짜 형식으로 입력해주세요."),gender:Y(),interests:Ze().array().min(1,"관심분야를 최소 하나 이상 선택해야 합니다.")}),eo=()=>{var L,z,B,O,h,C,S,j,N,V,y,A;const t=localStorage.getItem("token"),i=localStorage.getItem("user_id"),[s,a]=n.useState([]),r=$e(),d={token:t,user_id:i},{data:c}=At(d),o=Ii(),{openToast:l}=ke(),{register:p,handleSubmit:f,setValue:g,control:x,formState:{errors:m}}=ve({resolver:qe($r)});n.useEffect(()=>{c&&(a(c.data.interests),g("password",c.data.password),g("contact",c.data.contact),g("birth",c.data.birth),g("gender",c.data.sex?"woman":"man"),g("interests",c.data.interests))},[c,g]);const u=v=>{wt(v,g,"contact")},w=v=>{Ft(v,g,"birth")},_=(v,R)=>{const k=R?[...s,v]:s.filter(Z=>Z!==v);a(k),g("interests",k)},H=f(v=>{const R=()=>{if(v.gender==="man")return!1;if(v.gender==="woman")return!0},k={token:t,user_id:i,modifyData:{birth:v.birth,sex:R(),interests:v.interests}};v.contact&&(k.modifyData.contact=v.contact),v.password&&(k.modifyData.password=v.password),o.mutate(k,{onSuccess:()=>{l("저장 되었습니다.")},onError:Z=>{console.log(Z)}})});return e.jsx(Kr,{children:c&&e.jsxs(e.Fragment,{children:[e.jsxs(Gr,{children:[e.jsxs("div",{children:[e.jsx("span",{className:"label",children:"이름"}),e.jsx("span",{className:"info",children:c.data.name})]}),e.jsxs("div",{children:[e.jsx("span",{className:"label",children:"이메일(ID)"}),e.jsx("span",{className:"info",children:c.data.email})]})]}),e.jsxs(Xr,{onSubmit:H,children:[e.jsxs("div",{className:"td_form",children:[e.jsx(Vt,{label:"전화번호",type:"text",id:"contact",placeholder:"전화번호를 입력하세요",register:p,onChange:u}),((L=m.contact)==null?void 0:L.message)&&e.jsx("p",{className:"err_msg",children:(B=(z=m.contact)==null?void 0:z.message)==null?void 0:B.toString()})]}),e.jsxs("div",{className:"td_form",children:[e.jsx(Vt,{label:"비밀번호 변경",type:"password",id:"password",placeholder:"비밀번호를 입력하세요",register:p}),((O=m.password)==null?void 0:O.message)&&e.jsx("p",{className:"err_msg",children:(C=(h=m.password)==null?void 0:h.message)==null?void 0:C.toString()})]}),e.jsxs("div",{className:"radio_box",children:[e.jsx("p",{className:"label",children:"성별"}),e.jsx(It,{label:"남",id:"man",name:"gender",register:p}),e.jsx(It,{label:"여",id:"woman",name:"gender",register:p})]}),e.jsxs("div",{className:"td_form",children:[e.jsx(Vt,{label:"생년월일",type:"text",id:"birth",placeholder:"생년월일을 입력하세요",register:p,onChange:w}),((S=m.birth)==null?void 0:S.message)&&e.jsx("p",{className:"err_msg",children:(N=(j=m.birth)==null?void 0:j.message)==null?void 0:N.toString()})]}),e.jsxs("div",{className:"favorite_box",children:[e.jsx("p",{className:"label",children:"관심분야"}),e.jsx("div",{className:"favorite_list",children:e.jsx(Oe,{name:"interests",control:x,render:({field:v})=>{var R;return e.jsx(e.Fragment,{children:r&&v.value&&((R=r==null?void 0:r.data)==null?void 0:R.map(k=>e.jsx(Me,{label:k.name,id:JSON.stringify(k.id),checked:s.includes(k.id),onChange:Z=>{_(k.id,Z.target.checked)}},k.id)))})}})}),((V=m.interests)==null?void 0:V.message)&&e.jsx("p",{className:"err_msg",children:(A=(y=m.interests)==null?void 0:y.message)==null?void 0:A.toString()})]}),e.jsxs(Dr,{children:[e.jsx("button",{className:"submit_btn",children:"저장"}),e.jsx(E,{to:"/mypage/user-modify/with-draw",children:"마이스 메이트 탈퇴하기"})]})]})]})})},to=b.div`
  padding: 20px 0 0;
  position: relative;
`,io=b.div`
...
`,Uo=b.li`
  ...
  padding: 15px;
  cursor: pointer;
`,Qo=[{text:"베스트순",value:1},{text:"최신순",value:2}],Wo=({setSortType:t,width:i})=>{const[s,a]=n.useState(!1),[r,d]=n.useState("베스트순"),c=n.useRef(null),o=()=>{a(g=>!g)},l=g=>{t(g)},p=(g,x)=>{d(g),l(x),a(!1)},f=g=>{c.current&&!c.current.contains(g.target)&&a(!1)};return n.useEffect(()=>(document.addEventListener("mousedown",f),()=>{document.removeEventListener("mousedown",f)}),[]),e.jsxs(qo,{ref:c,$width:i,children:[e.jsxs(Po,{onClick:o,$isOn:s,children:[e.jsx("span",{className:"txt",children:r}),e.jsx("span",{children:s?e.jsx(Ge,{}):e.jsx(Ge,{})})]}),e.jsx(Yo,{$isOn:s,children:Qo.map(g=>e.jsx(Uo,{onClick:()=>p(g.text,g.value),children:g.text},g.value))})]})},Jo=b.div`
  position: relative;
  word-break: keep-all;
...
`,rl=({boothListData:t})=>e.jsx(al,{children:e.jsxs("ul",{children:[(t==null?void 0:t.items)&&(t==null?void 0:t.items.map(i=>e.jsx("li",{children:e.jsx("span",{className:"text",children:i.name})},i.id))),(t==null?void 0:t.items.length)<=0&&e.jsx("li",{children:e.jsx("span",{children:"참여기업 리스트가 없습니다."})})]})}),ol=({reviewData:t,boothListData:i,page:s,setPage:a,setSortType:r})=>{const[d,c]=n.useState("review");return e.jsxs(Io,{children:[e.jsxs(Oo,{children:[e.jsx("button",{onClick:()=>c("review"),className:d==="review"?"active":"",children:"리뷰"}),e.jsx("button",{onClick:()=>c("company"),className:d==="company"?"active":"",children:"참여 기업"})]}),e.jsxs(Zo,{children:[d==="review"&&e.jsx(nl,{reviewData:t,page:s,setPage:a,setSortType:r}),d==="company"&&e.jsx(rl,{boothListData:i.data})]})]})},ll=()=>{const{id:t}=ge(),i=localStorage.getItem("token"),s=localStorage.getItem("user_id"),a=localStorage.getItem("name"),[r,d]=n.useState(1),[c,o]=n.useState(1),[l,p]=n.useState(!0),{data:f,isLoading:g,error:x}=ft(1,i),{data:m,isLoading:u,isError:w}=nt(t,i),{data:_,isLoading:H,isError:L}=xa({token:i,user_id:s,event_id:JSON.parse(t),page:r,sort_type:c}),{data:z,isLoading:B,isError:O}=Wt(t,i);return n.useEffect(()=>{m&&p(!m.data.applied)},[m,l]),g||u||H||B?e.jsx(Ae,{}):x||w||L||O?e.jsx("div",{children:"데이터 없음"}):e.jsxs(uo,{className:"maxframe",children:[e.jsxs(bo,{children:[e.jsxs(jo,{children:[e.jsx(Jt,{thumnaildata:m.data,applyBtn:l}),e.jsx(Ro,{contentdata:m.data})]}),e.jsx(wo,{children:e.jsx(ol,{reviewData:_,boothListData:z,page:r,setPage:d,setSortType:o})})]}),e.jsx(gt,{title:a!==null?`AI 메이트가 맞추는 '${JSON.parse(a)}' 님의 취향저격 전시`:"AI메이트가 맞추는 취향저격 전시",eventList:f.data.items})]})},Di=b.div`
  line-height: 1.2;
  & h3 {
    font-size: 32px;
...
`,cl=({id:t,placeholder:i,setValue:s,register:a})=>e.jsx(dl,{children:e.jsx("textarea",{placeholder:i,onChange:r=>{s(r.target.value)},...a&&a(t)})}),pl=({label:t,required:i,keyId:s,onChange:a})=>{const r=c=>{a(s,c.target.value)},d=`textarea-${s}`;return e.jsxs(ts,{children:[e.jsx("p",{className:"label",children:e.jsxs("label",{htmlFor:d,children:[e.jsx("span",{className:"txt",children:t}),i&&e.jsx("span",{className:"req",children:" *"})]})}),e.jsx("div",{className:"select_box",children:e.jsx("textarea",{id:d,onChange:r,required:i,maxLength:150})})]})},xl=({EventApplyInformation:t,applyType:i,setApplyType:s,applyList:a,register:r,errors:d,setValue:c,isEdit:o,editData:l,setSurveyOption:p,setMultipleOption:f,setApplyLong:g,surveyErr:x})=>{var v,R,k,Z,J,q,W,P,G,T,K,ce,ue,me,be,Ne,Ve,Te;const[m,u]=n.useState(!1),[w,_]=n.useState(),[H,L]=n.useState([]),[z,B]=n.useState([]),[O,h]=n.useState({});n.useEffect(()=>{c("type",i),o&&(c("type",l==null?void 0:l.type),c("name",l==null?void 0:l.name),c("email",l==null?void 0:l.email),c("contact",l==null?void 0:l.contact),c("contact",l==null?void 0:l.contact),l!=null&&l.information&&l.information.forEach(I=>{c(`${I.name}`,I.answer)}),l!=null&&l.surveys&&(l==null||l.surveys.forEach((I,ee)=>{var Se;const re=(Se=t==null?void 0:t.data)==null?void 0:Se.surveys[ee].id;I.type===0&&(z.push({[re]:[I.answer]}),B(z)),I.type===1&&I.answer.map(we=>{A(I.options[we])}),I.type===2&&(V(re,I.answer),h({[re]:[I.answer]}),console.log(O))})))},[l,o,i]);const C=I=>{wt(I,c,"contact")},S=I=>{_(I),I&&c("xlsx",I)},j=n.useCallback(I=>{I.preventDefault(),I.stopPropagation();const ee=I.dataTransfer.files;ee&&ee.length>0&&S(ee[0])},[]),N=n.useCallback(I=>{I.preventDefault()},[]),V=(I,ee)=>{g(re=>({...re,[I]:[ee]}))},y=(I,ee,re)=>{if(I===1)return"무료";if(I===2)return`사전신청 무료 / 현장구매 유료(${ie(String(re))})`;if(I===3)return`사전 신청 무료 / 기간 한정 유료(${ie(String(ee))}) / 현장 구매 시 유료(${ie(String(re))})`;if(I===4)return`사전 신청 유료(${ie(String(ee))}) / 현장 결제 유료(${ie(String(re))})`;if(I===5)return`유료(${ie(String(re))})`},A=I=>{L(ee=>I&&(ee!=null&&ee.includes(I))?ee.filter(re=>re!==I):[...ee,I])};return e.jsxs(Di,{children:[e.jsx("div",{className:"field",children:e.jsxs("div",{className:"input_box",children:[e.jsx(Ga,{label:"신청 유형",required:!1,optionList:a,setTarget:s}),e.jsx("div",{className:"requird mt_16",children:y((v=t==null?void 0:t.data)==null?void 0:v.payable_type,(R=t==null?void 0:t.data)==null?void 0:R.payable_price1,(k=t==null?void 0:t.data)==null?void 0:k.payable_price2)})]})}),e.jsx("h3",{children:"신청자 기본정보"}),e.jsxs("div",{className:"field",children:[e.jsxs("div",{className:"input_box",children:[e.jsx(Ie,{label:"이름",type:"text",id:"name",register:r,required:!0}),((Z=d.name)==null?void 0:Z.message)&&e.jsx("p",{className:"err_msg",children:(q=(J=d.name)==null?void 0:J.message)==null?void 0:q.toString()})]}),e.jsxs("div",{className:"input_box",children:[e.jsx(Ie,{label:"이메일",type:"text",id:"email",register:r,required:!0}),((W=d.email)==null?void 0:W.message)&&e.jsx("p",{className:"err_msg",children:(G=(P=d.email)==null?void 0:P.message)==null?void 0:G.toString()})]}),e.jsxs("div",{className:"input_box",children:[e.jsx(Ie,{label:"휴대전화번호",type:"text",id:"contact",register:r,required:!0,onChange:C}),((T=d.contact)==null?void 0:T.message)&&e.jsx("p",{className:"err_msg",children:(ce=(K=d.contact)==null?void 0:K.message)==null?void 0:ce.toString()})]}),(ue=t==null?void 0:t.data)==null?void 0:ue.information.map(I=>e.jsx("div",{className:"input_box",children:e.jsx(Ie,{label:I.name,type:"text",id:I.name,required:I.required,register:r})},I.id))]}),((me=t==null?void 0:t.data)==null?void 0:me.surveys.length)>0&&e.jsxs(e.Fragment,{children:[e.jsx("h3",{children:"사전 설문"}),e.jsx("div",{className:"field",children:(be=t==null?void 0:t.data)==null?void 0:be.surveys.map(I=>I.type===0?e.jsx(e.Fragment,{children:e.jsxs("div",{className:"input_box",children:[e.jsx(Da,{id:I.id,label:I.title,required:I.required,optionList:I.options,setTarget:p,surveyType:z}),(x==null?void 0:x.includes(I.id))&&e.jsx("p",{className:"err_msg",children:"필수값 입니다."})]},I.id)}):I.type===1?e.jsx(e.Fragment,{children:e.jsxs("div",{className:"input_box",children:[e.jsx(Xa,{label:I.title,required:I.required,multipleSelect:H,children:I.options.map((ee,re)=>e.jsx(Me,{label:ee,id:ee,checked:H==null?void 0:H.includes(ee),onChange:Se=>{A(Se.target.id),f(we=>({...we,[I.id]:we[I.id]?we[I.id].includes(re)?we[I.id].filter(Re=>Re!==re):[...we[I.id],re]:[re]}))}},ee))}),(x==null?void 0:x.includes(I.id))&&e.jsx("p",{className:"err_msg",children:"필수값 입니다."})]},I.id)}):I.type===2?e.jsx("div",{className:"input_box",children:e.jsx(pl,{label:I.title,required:I.required,keyId:I.id,value:g[I.id]||O[I.id],onChange:V})},I.id):null)})]}),i===1&&e.jsxs(e.Fragment,{children:[e.jsx("h3",{children:"단체신청"}),e.jsxs($i,{children:[e.jsxs("div",{className:"input_box",children:[e.jsx(Ie,{label:"단체명",type:"text",id:"group",required:!0,register:r}),((Ne=d.group)==null?void 0:Ne.message)&&e.jsx("p",{className:"err_msg",children:(Te=(Ve=d.group)==null?void 0:Ve.message)==null?void 0:Te.toString()})]}),e.jsxs("div",{className:"title_area",children:[e.jsx("span",{className:"tit",children:"참가자 엑셀 등록하기"}),e.jsx("span",{className:"sub",children:"엑셀 양식으로 업로드하여 한번에 참가자를 등록할 수 있습니다. (지원 파일 양식 : xlsx)"})]}),e.jsxs("button",{type:"button",className:"download_btn",children:[e.jsx("span",{className:"icon",children:e.jsx(es,{})}),e.jsx("span",{className:"txt",children:e.jsx("a",{href:"/host/downloadFile/[마이스메이트]참가자리스트_엑셀추가하기.xlsx",download:"[마이스메이트]참가자리스트_엑셀추가하기.xlsx",children:"엑셀 양식 내려받기"})})]}),e.jsxs("p",{className:"alret_chang",children:[e.jsx("span",{className:"icon",children:e.jsx(Gt,{})}),e.jsx("span",{className:"txt",children:"정보/그룹을 수정한 경우 새로운 양식으로 등록해주세요."})]}),e.jsxs("div",{className:"agree",children:[e.jsx("p",{className:"sub",children:"개인정보 보호를 위해 제3자 제공 동의가 완료된 참가자 명단을 등록할 수 있습니다."}),e.jsx(Me,{label:"네, 제3자 제공 동의를 받은 개인 정보입니다.",id:"excel_agree",register:r,onChange:I=>{const ee=I.target;u(ee.checked)}})]}),e.jsx("p",{className:"sub",children:"엑셀 양식을 업로드해주세요."}),e.jsxs("div",{onDrop:j,onDragOver:N,className:"upload",children:[e.jsxs("label",{htmlFor:"excelUpload",className:"label",children:[e.jsx("span",{className:"btn",children:"업로드 파일 선택"}),e.jsx("span",{className:"txt",children:w?w==null?void 0:w.name:"또는 여기에 끌어서 놓기"})]}),e.jsx("input",{type:"file",id:"excelUpload",...r("xlsx"),disabled:!m,style:{display:"none"},onChange:I=>S(I.target.files?I.target.files[0]:null)})]})]})]})]})},hl=b.div`
  width: 100%;
...
`,is=({applyType:t,register:i,setValue:s,watch:a,isEdit:r=!1})=>{const d=["agree1","agree2","agree3","agree4"],o=a(d).every(Boolean),l=p=>{d.forEach(f=>s(f,p))};return n.useEffect(()=>{s("allAgree",o)},[o,s]),e.jsxs(hl,{children:[e.jsx("h3",{children:"신청 내용"}),e.jsxs("div",{className:"apply_desc",children:[e.jsxs("div",{className:"type",children:[e.jsx("span",{className:"tit",children:"신청 유형"}),e.jsx("span",{className:"info",children:t===0?"개인 신청":"단체 신청"})]}),e.jsxs("div",{className:"type",children:[e.jsx("span",{className:"tit",children:"신청 비용"}),e.jsx("span",{className:"info",children:"사전등록 무료"})]})]}),e.jsx("div",{className:"all_chk",children:e.jsx(Me,{label:"전체 동의하기",id:"allChk",register:i,checked:o,onChange:p=>{const f=p.target;l(f.checked)}})}),e.jsxs("div",{className:"agree_list",children:[e.jsxs("div",{children:[e.jsx(Me,{label:"(필수) 성별 생년 정보 제공 동의",id:"agree1",register:i}),e.jsx("p",{className:"link",children:e.jsx(E,{to:"/gender-birth-information",target:"blank_",children:"자세히 보기"})})]}),e.jsxs("div",{children:[e.jsx(Me,{label:"(필수) 개인정보 수집 이용 동의",id:"agree2",register:i}),e.jsx("p",{className:"link",children:e.jsx(E,{to:"/personal-information",target:"blank_",children:"자세히 보기"})})]}),e.jsxs("div",{children:[e.jsx(Me,{label:"(필수) 제 3자 제공 동의",id:"agree3",register:i}),e.jsx("p",{className:"link",children:e.jsx(E,{to:"/onward-transfer",target:"blank_",children:"자세히 보기"})})]}),e.jsxs("div",{children:[e.jsx(Me,{label:"(선택) 마케팅 정보 수신 동의",id:"agree4",register:i}),e.jsx("p",{className:"link",children:e.jsx(E,{to:"/markeyting-information",target:"blank_",children:"자세히 보기"})})]})]}),e.jsx("div",{className:"submit_btn",children:e.jsx("button",{type:"submit",disabled:!(a("agree1")&&a("agree2")&&a("agree3")),children:r?"수정하기":"사전 신청하기"})})]})},ss=b.div``,ns=b.form`
...
`,Ul=()=>{var L,z,B,O;const t=localStorage.getItem("token"),i=localStorage.getItem("user_id"),s=Gn(),{openConfirm:a}=Xe(),[r,d]=n.useState(!1),c=Fe(Ye),o=Fe(je),l=Be(Ye),{openAlret:p}=ze(),f=$(),[g,x]=n.useState(!1),[m,u]=n.useState(!1),_=jt({token:t,user_id:i,type:1,page:1});n.useEffect(()=>{var h,C;((C=(h=_==null?void 0:_.data)==null?void 0:h.data)==null?void 0:C.total)<=0&&m?x(!0):x(!1)},[(z=(L=_==null?void 0:_.data)==null?void 0:L.data)==null?void 0:z.total,m]);const H=()=>{a({text:"탈퇴하시겠습니까?",okBtn:"확인",logout:!1})};return n.useEffect(()=>{d(l.confirm)},[l.confirm]),n.useEffect(()=>{if(r===!0){const h={token:t,user_id:i};s.mutate(h,{onSuccess:()=>{d(!1),c(),o(),f("/with-draw-finish")},onError:()=>{const C={text:"요청이 실패하였습니다. 다시 시도해 주세요."};d(!1),p(C)}})}d(l.confirm)},[r]),e.jsxs(Yl,{children:[e.jsx("div",{className:"title",children:"그 동안 서비스를 이용해주셔서 감사합니다."}),e.jsxs("div",{className:"info_box",children:["- 회원탈퇴 신청 시, 회원님 이메일 아이디로 즉시 탈퇴 처리가 진행됩니다.",e.jsx("br",{}),"- 회원가입 시, 입력한 회원정보는 모두 삭제됩니다.",e.jsx("br",{}),"- 회원탈퇴가 완료된 이메일은 본인을 포함한 타인 모두 재사용이나 복구가 불가능합니다.",e.jsx("br",{}),"- 회원탈퇴 완료 후, 삭제된 행사와 접수내역의 데이터는 복구되지 않습니다.",e.jsx("br",{}),"- 등록한 행사나 참가한 행사 중에 진행중인 행사가 있을 시, 탈퇴가 불가능합니다. 행사 내역 삭제나 취소를 후에 탈퇴 부탁드립니다."]}),e.jsx("div",{className:"chk_wrap",children:e.jsx(Me,{label:"안내사항을 모두 확인하였으며, 이에 동의합니다.",id:"agree01",onChange:h=>{u(h.target.checked)}})}),e.jsxs("div",{className:"btn_area",children:[((O=(B=_==null?void 0:_.data)==null?void 0:B.data)==null?void 0:O.total)>0&&e.jsx("span",{className:"err_txt",children:"참가한 행사가 존재합니다. [마이페이지 >신청 행사 내역]에서 취소해주세요."}),e.jsx("button",{onClick:H,disabled:!g,children:"탈퇴하기"})]})]})},Ql=b.div`
  min-height: 70vh;
  padding-top: 200px;
  @media (max-width: 1024px) {
    min-height: 80vh;
...
`,Xl=()=>{var B;const t=localStorage.getItem("token"),i=localStorage.getItem("name"),s=$(),a=fe(),r=Fe(je),{data:d,isError:c}=zt(t),{id:o}=ge(),{data:l}=nt(o,t),[p,f]=n.useState(0),[g,x]=n.useState(""),{openAlret:m,alretData:u}=ze(),w=na(),{register:_,handleSubmit:H}=ve();n.useEffect(()=>{if(!t||c&&d===void 0){s("/login",{state:{from:a},replace:!0}),r();return}},[]);const L=O=>{f(O)};console.log(u);const z=H((O,h)=>{if(h.preventDefault(),p===0&&!O.desc){x("별점을 선택하고 리뷰를 입력해주세요");return}else if(p===0){x("별점을 선택해주세요");return}else if(O.desc.length<=0){x("리뷰를 입력해주세요");return}w.mutate({token:t,event_id:o,data:{rate:p,content:O.desc}},{onSuccess:()=>{m({text:"리뷰작성이 완료되었습니다.",callback:()=>{s(`/detail/${o}`)}})},onError:C=>{console.log(C.status===400),C.status===400&&m({text:"신청행사가 아니거나 종료된 행사가 아닙니다.",callback:()=>{s("/")}})}}),x("")});return console.log(g),e.jsxs(Jl,{children:[l&&e.jsx(Kl,{children:e.jsx("img",{src:`https://api.micemate.io/storage/${(B=l==null?void 0:l.data)==null?void 0:B.img}`})}),e.jsxs(Gl,{onSubmit:z,children:[e.jsxs("div",{className:"text_box",children:[e.jsxs("span",{children:[JSON.parse(i),"님, 참여한 행사는 어떠셨나요?"]}),e.jsx("span",{children:"리뷰를 남겨주시면 더 좋은 행사를 준비하는데에 큰 도움이 될 수 있어요!"})]}),e.jsx(qt,{rating:p,changeRating:L,numberOfStars:5,starRatedColor:"rgba(30, 158, 255, 1)",starHoverColor:"rgba(30, 158, 255, 1)",starEmptyColor:"rgba(85, 85, 85, 1)",svgIconPath:Kt}),e.jsx("div",{className:"input_text_area",children:e.jsx(cl,{id:"desc",placeholder:"참여한 행사에 대해 더 남겨주실 의견이 있으신가요?",register:_})}),g&&e.jsx("span",{style:{display:"block",marginBottom:"10px"},className:"err_msg",children:g}),e.jsx("div",{className:"submit_area",children:e.jsx("button",{type:"submit",children:"리뷰 남기기"})})]})]})},rt=b.div`
  max-width: 1496px;
...
`,Qd=({target:t,setClose:i})=>{var f,g,x,m,u,w,_,H,L,z,B,O,h,C,S,j,N,V,y,A;const s=localStorage.getItem("token"),{data:a}=nt(t,s),[r,d]=n.useState(null),[c,o]=n.useState(!1),l=(v,R,k)=>{if(v===1)return"무료";if(v===2)return`사전신청 무료 / 현장구매 유료(${ie(String(R))})`;if(v===3)return`사전 신청 무료 / 기간 한정 유료(${ie(String(R))}) / 현장 구매 시 유료(${ie(String(k))})`;if(v===4)return`사전 신청 유료(${ie(String(R))}) / 현장 결제 유료(${ie(String(k))})`;if(v===5)return`유료(${ie(String(k))})`},p=v=>{d(r===v?null:v)};return e.jsx(Ud,{children:e.jsxs("div",{className:"preview_page",children:[e.jsx("button",{onClick:()=>{i(!1)},className:"close_btn"}),e.jsxs("div",{className:"cont_wrap",children:[e.jsxs("div",{className:"top_wrap",children:[e.jsx("div",{className:"m_img",children:e.jsx("img",{src:`https://api.micemate.io/storage/${(f=a==null?void 0:a.data)==null?void 0:f.img}`})}),e.jsxs("div",{className:"tit_area",children:[e.jsxs("div",{className:"area_l",children:[e.jsxs("div",{className:"title",children:[e.jsx("strong",{children:(g=a==null?void 0:a.data)==null?void 0:g.title}),e.jsx("div",{className:"d_day_tag",children:"D-1"})]}),e.jsxs("div",{className:"desc",children:[`${He((x=a==null?void 0:a.data)==null?void 0:x.event_start_date)} ~
            ...
            ${He((_=a==null?void 0:a.data)==null?void 0:_.event_end_date)}`})]}),e.jsxs("li",{children:[e.jsx("div",{className:"key",children:"개최 장소"}),e.jsx("div",{className:"val",children:(H=a==null?void 0:a.data)==null?void 0:H.position1})]}),e.jsxs("li",{children:[e.jsx("div",{className:"key",children:"세부 장소"}),e.jsx("div",{className:"val",children:(L=a==null?void 0:a.data)==null?void 0:L.position2})]}),e.jsxs("li",{children:[e.jsx("div",{className:"key",children:"전시 분야"}),e.jsx("div",{className:"val",children:(z=a==null?void 0:a.data)==null?void 0:z.category.name})]}),e.jsxs("li",{children:[e.jsx("div",{className:"key",children:"참가 비용"}),e.jsx("div",{className:"val",children:l((B=a==null?void 0:a.data)==null?void 0:B.payable_type,(O=a==null?void 0:a.data)==null?void 0:O.payable_price1,(h=a==null?void 0:a.data)==null?void 0:h.payable_price2)})]})]})]}),!c&&e.jsxs("div",{id:"_detail",children:[e.jsx("div",{className:"tit",children:"상세 정보"}),e.jsxs("div",{className:"detail_imgs",children:[e.jsx("div",{dangerouslySetInnerHTML:{__html:(C=a==null?void 0:a.data)==null?void 0:C.content}}),e.jsx("button",{onClick:()=>o(!0),className:"btn blue detail_more_btn",children:"더보기"})]})]}),c&&e.jsxs("div",{id:"_detail",children:[e.jsx("div",{className:"tit",children:"상세 정보"}),e.jsxs("div",{className:"detail_imgs",style:{maxHeight:"auto"},children:[e.jsx("div",{dangerouslySetInnerHTML:{__html:(S=a==null?void 0:a.data)==null?void 0:S.content}}),e.jsx("button",{onClick:()=>o(!1),className:"btn blue detail_more_btn",children:"더보기"})]})]}),e.jsxs("div",{id:"_faq",children:[e.jsx("div",{className:"tit",children:"FAQ"}),e.jsx("ul",{className:"faq_list",children:(N=(j=a==null?void 0:a.data)==null?void 0:j.faqs)==null?void 0:N.map((v,R)=>e.jsxs("li",{children:[e.jsx("div",{onClick:()=>p(R),className:"q_txt",children:v.question}),r===R&&e.jsx("div",{className:"a_txt",children:v.answer})]}))})]}),e.jsxs("div",{id:"_call",children:[e.jsx("div",{className:"tit",children:"문의하기"}),e.jsxs("ul",{className:"key_val_list",children:[e.jsxs("li",{children:[e.jsx("div",{className:"key",children:"담당자"}),e.jsx("div",{className:"val",children:(V=a==null?void 0:a.data)==null?void 0:V.contact_name})]}),e.jsxs("li",{children:[e.jsx("div",{className:"key",children:"전화번호"}),e.jsx("div",{className:"val",children:(y=a==null?void 0:a.data)==null?void 0:y.contact_number})]}),e.jsxs("li",{children:[e.jsx("div",{className:"key",children:"이메일"}),e.jsx("div",{className:"val",children:(A=a==null?void 0:a.data)==null?void 0:A.contact_email})]})]})]})]})]})]}),e.jsxs("div",{className:"review_wrap",children:[e.jsxs("div",{className:"tab_btns",children:[e.jsx("button",{className:"tab_btn active",children:"리뷰"}),e.jsx("button",{className:"tab_btn",children:"참여 기업"})]}),e.jsxs("div",{className:"blue_comment_box",children:["전시회 참여 후 리뷰를 작성해주세요.",e.jsx("br",{}),"고객님의 리뷰는 다른 사용자들에게 큰 도움이 됩니다!",e.jsx("button",{className:"blue_comment_box_delete"})]}),e.jsxs("div",{className:"comment_box",children:[e.jsxs("div",{className:"top_wrap",children:[e.jsxs("div",{className:"score_wrap",children:[e.jsxs("div",{className:"stars",children:[e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"40%"}})})]}),e.jsx("div",{className:"txt",children:"4,423개 평점"}),e.jsx("div",{className:"score_num",children:"4.4"})]}),e.jsxs("select",{className:"select",children:[e.jsx("option",{value:"1",children:"베스트순"}),e.jsx("option",{value:"2",children:"최신순"})]})]}),e.jsxs("ul",{className:"comment_list",children:[e.jsxs("li",{children:[e.jsxs("div",{className:"stars",children:[e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})})]}),e.jsx("div",{className:"username",children:"마이스미츄 · 2024년 08월 23일"}),e.jsxs("div",{className:"comment_txt",children:["극장에서 보고 두번째는 쿠플에서 봤는데 다시봐도 재미있네요.",e.jsx("br",{}),"아쿠아맨2도 쿠플에서 볼 수 있기를..."]}),e.jsx("div",{className:"btn_wrap",children:e.jsx("button",{className:"like_btn active",children:"30"})})]}),e.jsxs("li",{children:[e.jsxs("div",{className:"stars",children:[e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"0%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"0%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"0%"}})})]}),e.jsx("div",{className:"username",children:"마이스미츄 · 2024년 08월 23일"}),e.jsxs("div",{className:"comment_txt",children:["극장에서 보고 두번째는 쿠플에서 봤는데 다시봐도 재미있네요.",e.jsx("br",{}),"아쿠아맨2도 쿠플에서 볼 수 있기를..."]}),e.jsx("div",{className:"btn_wrap",children:e.jsx("button",{className:"like_btn",children:"30"})})]}),e.jsxs("li",{children:[e.jsxs("div",{className:"stars",children:[e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"40%"}})})]}),e.jsx("div",{className:"username",children:"마이스미츄 · 2024년 08월 23일"}),e.jsxs("div",{className:"comment_txt",children:["극장에서 보고 두번째는 쿠플에서 봤는데 다시봐도 재미있네요.",e.jsx("br",{}),"아쿠아맨2도 쿠플에서 볼 수 있기를..."]}),e.jsx("div",{className:"btn_wrap",children:e.jsx("button",{className:"like_btn",children:"30"})})]}),e.jsxs("li",{children:[e.jsxs("div",{className:"stars",children:[e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"40%"}})})]}),e.jsx("div",{className:"username",children:"마이스미츄 · 2024년 08월 23일"}),e.jsxs("div",{className:"comment_txt",children:["극장에서 보고 두번째는 쿠플에서 봤는데 다시봐도 재미있네요.",e.jsx("br",{}),"아쿠아맨2도 쿠플에서 볼 수 있기를..."]}),e.jsx("div",{className:"btn_wrap",children:e.jsx("button",{className:"like_btn",children:"30"})})]}),e.jsxs("li",{children:[e.jsxs("div",{className:"stars",children:[e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"40%"}})})]}),e.jsx("div",{className:"username",children:"마이스미츄 · 2024년 08월 23일"}),e.jsxs("div",{className:"comment_txt",children:["극장에서 보고 두번째는 쿠플에서 봤는데 다시봐도 재미있네요.",e.jsx("br",{}),"아쿠아맨2도 쿠플에서 볼 수 있기를..."]}),e.jsx("div",{className:"btn_wrap",children:e.jsx("button",{className:"like_btn",children:"30"})})]}),e.jsxs("li",{children:[e.jsxs("div",{className:"stars",children:[e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"40%"}})})]}),e.jsx("div",{className:"username",children:"마이스미츄 · 2024년 08월 23일"}),e.jsxs("div",{className:"comment_txt",children:["극장에서 보고 두번째는 쿠플에서 봤는데 다시봐도 재미있네요.",e.jsx("br",{}),"아쿠아맨2도 쿠플에서 볼 수 있기를..."]}),e.jsx("div",{className:"btn_wrap",children:e.jsx("button",{className:"like_btn",children:"30"})})]}),e.jsxs("li",{children:[e.jsxs("div",{className:"stars",children:[e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"40%"}})})]}),e.jsx("div",{className:"username",children:"마이스미츄 · 2024년 08월 23일"}),e.jsxs("div",{className:"comment_txt",children:["극장에서 보고 두번째는 쿠플에서 봤는데 다시봐도 재미있네요.",e.jsx("br",{}),"아쿠아맨2도 쿠플에서 볼 수 있기를..."]}),e.jsx("div",{className:"btn_wrap",children:e.jsx("button",{className:"like_btn",children:"30"})})]}),e.jsxs("li",{children:[e.jsxs("div",{className:"stars",children:[e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"40%"}})})]}),e.jsx("div",{className:"username",children:"마이스미츄 · 2024년 08월 23일"}),e.jsxs("div",{className:"comment_txt",children:["극장에서 보고 두번째는 쿠플에서 봤는데 다시봐도 재미있네요.",e.jsx("br",{}),"아쿠아맨2도 쿠플에서 볼 수 있기를..."]}),e.jsx("div",{className:"btn_wrap",children:e.jsx("button",{className:"like_btn",children:"30"})})]}),e.jsxs("li",{children:[e.jsxs("div",{className:"stars",children:[e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"40%"}})})]}),e.jsx("div",{className:"username",children:"마이스미츄 · 2024년 08월 23일"}),e.jsxs("div",{className:"comment_txt",children:["극장에서 보고 두번째는 쿠플에서 봤는데 다시봐도 재미있네요.",e.jsx("br",{}),"아쿠아맨2도 쿠플에서 볼 수 있기를..."]}),e.jsx("div",{className:"btn_wrap",children:e.jsx("button",{className:"like_btn",children:"30"})})]}),e.jsxs("li",{children:[e.jsxs("div",{className:"stars",children:[e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"100%"}})}),e.jsx("span",{children:e.jsx("i",{style:{width:"40%"}})})]}),e.jsx("div",{className:"username",children:"마이스미츄 · 2024년 08월 23일"}),e.jsxs("div",{className:"comment_txt",children:["극장에서 보고 두번째는 쿠플에서 봤는데 다시봐도 재미있네요.",e.jsx("br",{}),"아쿠아맨2도 쿠플에서 볼 수 있기를..."]}),e.jsx("div",{className:"btn_wrap",children:e.jsx("button",{className:"like_btn",children:"30"})})]})]}),e.jsxs("div",{className:"pagination",children:[e.jsx("button",{className:"pagi_prev"}),e.jsx("button",{className:"num active",children:"1"}),e.jsx("button",{className:"num",children:"2"}),e.jsx("button",{className:"num",children:"3"}),e.jsx("button",{className:"num",children:"4"}),e.jsx("button",{className:"pagi_next"})]})]})]})]})})},yi=t=>{switch(t){case 0:return{text:"· 작성중",class:"col_orange"};case 1:return{text:"· 승인 대기중",class:"col_darkblue"};case 2:return{text:"· 수정 필요",class:"col_orange"};case 3:return{text:"· 완료",class:"col_darkblue"};default:return{text:"-",class:"col_blue"}}},Wd=[{title:"기본정보",key:"general"},{title:"상세페이지",key:"detail"},{title:"모집정보",key:"application"},{title:"사전설문",key:"survey",url:"survey"},{title:"FAQ & 문의",key:"faq",url:"faq"}],Jd=()=>{var m,u;const t=localStorage.getItem("token"),i=Pi(),a=Ue().authInfo,{id:r}=ge(),[d,c]=n.useState(!1),{openToast:o}=ke(),l=$(),{data:p,isLoading:f,isError:g}=fa({token:a.token,event_id:r}),x=()=>{i.mutate({token:t,event_id:r},{onSuccess:()=>{l("/host/my/apply-register/edit/finish")},onError:()=>{o("작성중인 필드가 있습니다.")}})};return f?e.jsx(Ae,{}):g||!p?e.jsx("div",{children:"데이터를 불러오는 중 에러가 발생했습니다."}):e.jsxs("div",{className:"cont_area",children:[e.jsxs("div",{className:"cont_panel type2",children:[e.jsx("div",{className:"tit_wrap",children:e.jsx("h2",{className:"fs_40 fw_700",children:"행사 상세설정"})}),e.jsx("div",{className:"tit_wrap mt_12",children:e.jsx("h3",{className:"fs_18",children:"행사 등록을 위해 내용을 작성해주세요."})}),e.jsx("div",{className:"tit_wrap mt_44",children:e.jsx("h3",{className:"fs_20",children:"행사 등록 준비 상태"})}),e.jsx("div",{className:"dis_flex mt_16",children:e.jsxs("div",{className:"border_item w_767",children:[e.jsx("span",{className:`${yi((m=p==null?void 0:p.data)==null?void 0:m.state).class}`,children:yi((u=p==null?void 0:p.data)==null?void 0:u.state).text}),e.jsx("p",{className:"fs_12 fw_500",children:"아래의 필수 항목들이 모두 작성 완료 상태로 바뀌면 [제출하기]를 누룰 수 있습니다."})]})}),e.jsx("div",{className:"tit_wrap mt_26",children:e.jsx("h3",{className:"fs_20",children:"작성 항목"})}),e.jsx("div",{className:"dis_flex mt_16",children:e.jsx("div",{className:"w_767",children:e.jsx("ul",{className:"border_item_list",children:Wd.map(w=>{var _,H,L,z,B,O,h,C,S,j,N,V,y,A;return e.jsxs("li",{className:"blue",children:[e.jsx("span",{className:"tit",children:w.title}),((_=p==null?void 0:p.data)==null?void 0:_.state)===0&&((H=p==null?void 0:p.data)==null?void 0:H[w.key])===!0&&e.jsx("span",{className:"state col_blue",children:"작성 완료"}),((L=p==null?void 0:p.data)==null?void 0:L.state)===1&&((z=p==null?void 0:p.data)==null?void 0:z[w.key])===!0&&e.jsx("span",{className:"state col_blue",children:"작성 완료"}),((B=p==null?void 0:p.data)==null?void 0:B.state)===2&&((O=p==null?void 0:p.data)==null?void 0:O[w.key])===!0&&e.jsx("span",{className:"state col_blue",children:"작성 완료"}),((h=p==null?void 0:p.data)==null?void 0:h.state)===3&&((C=p==null?void 0:p.data)==null?void 0:C[w.key])===!0&&e.jsx("span",{className:"state col_blue",children:"작성 완료"}),((S=p==null?void 0:p.data)==null?void 0:S.state)===0&&((j=p==null?void 0:p.data)==null?void 0:j[w.key])===!1&&e.jsx("span",{className:"state col_yellow",children:"작성 중"}),((N=p==null?void 0:p.data)==null?void 0:N.state)===1&&((V=p==null?void 0:p.data)==null?void 0:V[w.key])===!1&&e.jsx("span",{className:"state col_yellow",children:"작성 전"}),((y=p==null?void 0:p.data)==null?void 0:y.state)===2&&((A=p==null?void 0:p.data)==null?void 0:A[w.key])===!1&&e.jsx("span",{className:"state col_yellow",children:"수정 중"}),e.jsx(E,{to:`/host/my/apply-register/edit/${r}/${w.key}`,className:"btn gray",children:"작성하기"})]},w.key)})})})}),e.jsxs("div",{className:"dis_flex justify_between mt_40",children:[e.jsx("div",{className:"btn_wrap"}),e.jsxs("div",{className:"btn_wrap gap23",children:[e.jsx(E,{to:`/host/${r}/preview`,target:"_blank",className:"btn blue_bor",children:"미리보기"}),e.jsx("button",{onClick:x,className:"btn dark_blue",children:"제출하기"})]})]})]}),d&&e.jsx(Qd,{target:r,setClose:c})]})},Kd=[{type:0,name:"행사 비용을 선택해주세요."},{type:1,name:"무료"},{type:2,name:"사전 신청 시 무료 / 현장 구매 시 유료"},{type:3,name:"사전 신청 시 무료 / 기간 한정 유료 / 현장 구매 시 유료"},{type:4,name:"사전 신청 유료 / 현장 결제 유료"},{type:5,name:"유료"}],Gd=()=>{var ce,ue,me,be,Ne,Ve,Te,I,ee,re,Se,we,Re,Qe,M,Q,le,oe,Ce,pe,Le,We,ot,lt,dt;const{openToast:t}=ke(),{id:i}=ge(),s=$(),[a,r]=n.useState(!1),c=Ue().authInfo,[o,l]=n.useState(null),[p,f]=n.useState(null),[g,x]=n.useState(null),[m,u]=n.useState(null),w=$e(),_=ua(),H=Ts.useDaumPostcodePopup(),L={token:c.token,event_id:i},{data:z}=Yi(L),B=10*1024*1024,O=Pe({title:Y().trim().min(1,"제목을 입력해주세요."),category:Ze().nullable().optional(),img1:Tt().nullable().optional().refine(F=>!F||F.length===0?!0:F[0].size<B,{message:"파일 크기는 10MB 이하이어야 합니다."}),img2:Tt().nullable().optional().refine(F=>!F||F.length===0?!0:F[0].size<B,{message:"파일 크기는 10MB 이하이어야 합니다."}),event_start_view:Y().nullable().optional(),event_end_view:Y().nullable().optional(),event_start_time:gi().nullable().optional(),event_end_time:gi().nullable().optional(),payable_type:Ze().nullable().optional(),payable_start_view:Y().nullable().optional(),payable_end_view:Y().nullable().optional(),payable_price_url:Y().nullable().optional(),payable_price1:Ze().nullable().optional(),payable_price2:Ze().nullable().optional(),progress_type:Y().nullable().optional(),progress_url:Y().nullable().optional(),position1:Y().nullable().optional(),position2:Y().nullable().optional()}).refine(F=>F.event_start_view&&F.event_end_view?new Date(F.event_start_view)<=new Date(F.event_end_view):!0,{message:"종료 날짜는 시작 날짜 이후여야 합니다.",path:["event_end_date"]}).refine(F=>F.payable_start_view&&F.payable_end_view?new Date(F.payable_start_view)<=new Date(F.payable_end_view):!0,{message:"종료 날짜는 시작 날짜 이후여야 합니다.",path:["payable_end_date"]}).refine(F=>{var D,he,_e,Je;const X=(D=z==null?void 0:z.data)!=null&&D.application_start_date?new Date((he=z==null?void 0:z.data)==null?void 0:he.application_start_date):null,se=(_e=z==null?void 0:z.data)!=null&&_e.application_end_date?new Date((Je=z==null?void 0:z.data)==null?void 0:Je.application_end_date):null;if(!X||!se)return!0;let te=!1;if(F.payable_start_view&&F.payable_end_view){const ct=new Date(F.payable_start_view),pt=new Date(F.payable_end_view);(ct<X||ct>se)&&(te=!0),(pt<X||pt>se)&&(te=!0)}return!te},{message:"유료 사전 신청 기간은 모집기간 안에 포함되어야 합니다.",path:["payable_end_date"]}),{data:h}=Qt({token:c.token,event_id:i}),{register:C,handleSubmit:S,setValue:j,watch:N,control:V,formState:{errors:y}}=ve({resolver:qe(O)});console.log(y);const A=N("event_start_time"),v=N("event_end_time"),R=N("payable_type"),k=N("progress_type");n.useEffect(()=>{var F,X,se,te,D,he,_e,Je,ct,pt,Xt,Dt,$t,ei,ti,ii,si,ni,ai,ri,oi,li,di,ci,pi,xi,hi,mi;h&&(h!=null&&h.data)&&(j("title",(F=h==null?void 0:h.data)==null?void 0:F.title),j("category",(se=(X=h==null?void 0:h.data)==null?void 0:X.category)==null?void 0:se.id),(te=h==null?void 0:h.data)!=null&&te.img1&&x(`https://api.micemate.io/storage/${(D=h==null?void 0:h.data)==null?void 0:D.img1}`),(he=h==null?void 0:h.data)!=null&&he.img2&&u(`https://api.micemate.io/storage/${(_e=h==null?void 0:h.data)==null?void 0:_e.img2}`),j("event_start_date",Ee((Je=h==null?void 0:h.data)==null?void 0:Je.event_start_date)),j("event_start_view",Ee((ct=h==null?void 0:h.data)==null?void 0:ct.event_start_date)),j("event_end_date",Ee((pt=h==null?void 0:h.data)==null?void 0:pt.event_end_date)),j("event_end_view",Ee((Xt=h==null?void 0:h.data)==null?void 0:Xt.event_end_date)),j("event_start_time",kt((Dt=h==null?void 0:h.data)==null?void 0:Dt.event_start_date)),j("event_end_time",kt(($t=h==null?void 0:h.data)==null?void 0:$t.event_end_date)),j("payable_type",(ei=h==null?void 0:h.data)==null?void 0:ei.payable_type),j("payable_start_view",Ee((ti=h==null?void 0:h.data)==null?void 0:ti.payable_start_date)),j("payable_start_date",Ee((ii=h==null?void 0:h.data)==null?void 0:ii.payable_start_date)),j("payable_end_view",Ee((si=h==null?void 0:h.data)==null?void 0:si.payable_end_date)),j("payable_end_date",Ee((ni=h==null?void 0:h.data)==null?void 0:ni.payable_end_date)),j("payable_price_url",(ai=h==null?void 0:h.data)==null?void 0:ai.payable_price_url),j("payable_price1",Number((ri=h==null?void 0:h.data)==null?void 0:ri.payable_price1)>0?(oi=h==null?void 0:h.data)==null?void 0:oi.payable_price1:null),j("payable_price2",Number((li=h==null?void 0:h.data)==null?void 0:li.payable_price2)>0?(di=h==null?void 0:h.data)==null?void 0:di.payable_price2:null),j("progress_type",JSON.stringify((ci=h==null?void 0:h.data)==null?void 0:ci.progress_type)),j("progress_url",((pi=h==null?void 0:h.data)==null?void 0:pi.progress_url)===null?"":(xi=h==null?void 0:h.data)==null?void 0:xi.progress_url),j("position1",(hi=h==null?void 0:h.data)==null?void 0:hi.position1),j("position2",(mi=h==null?void 0:h.data)==null?void 0:mi.position2))},[h]);const Z=(F,X)=>{Ft(F,j,X)},J=(F,X,se)=>{if(F.target.files){const te=F.target.files[0],D=URL.createObjectURL(te);te&&(se(te),X(D))}},q=(F,X,se,te)=>{F.preventDefault(),j(X,null),se(null),te(null)},W=(F,X)=>{const se=N(X),te=new Date(F);se&&(te.setMinutes(te.getMinutes()+30),j(X,te))},P=(F,X)=>{const se=N(X),te=new Date(F);se&&(te.setMinutes(te.getMinutes()-30),j(X,te))},G=F=>{let X="";F.userSelectedType==="R"?X=F.roadAddress:X=F.jibunAddress,j("position1",X)},T=()=>{H({onComplete:G})},K=S(F=>{const X=new FormData,se=Nt(F.event_start_time),te=Nt(F.event_end_time),D=(he,_e)=>{_e!=null&&!(_e instanceof File&&_e.size===0)&&X.append(he,_e)};D("title",F.title),D("category_id",F.category),D("img1",o||void 0),D("img2",p||void 0),D("event_start_date",F.event_start_view&&se?`${F.event_start_view} ${se}`:void 0),D("event_end_date",F.event_end_view&&te?`${F.event_end_view} ${te}`:void 0),D("payable_type",F.payable_type),D("payable_start_date",F.payable_start_view),D("payable_end_date",F.payable_end_view),D("payable_price_url",F.payable_price_url),D("payable_price1",F.payable_price1),D("payable_price2",F.payable_price2),D("progress_type",JSON.parse(F.progress_type)),D("progress_url",F.progress_url),D("position1",F.position1),D("position2",F.position2),_.mutate({token:c.token,event_id:i,data:X},{onSuccess:()=>{a===!0&&s(`/host/my/apply-register/edit/${i}/detail`),t("저장 되었습니다.")},onError:he=>{console.log(he)}})});return e.jsx("div",{className:"cont_area",children:e.jsxs("div",{className:"cont_panel type2",children:[e.jsx("div",{className:"tit_wrap",children:e.jsx("h2",{className:"fs_40 fw_700",children:"기본정보"})}),e.jsx("div",{className:"tit_wrap mt_12",children:e.jsx("h3",{className:"fs_18",children:"참관객 모집을 위한 행사의 기본 정보를 입력해주세요."})}),e.jsxs("form",{onSubmit:K,children:[e.jsx("div",{className:"tit_wrap mt_62",children:e.jsxs("h3",{className:"fs_20",children:["프로젝트 제목 ",e.jsx("i",{className:"col_red",children:"*"})]})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsx("input",{...C("title"),className:`w_767 ${(ue=(ce=h==null?void 0:h.data)==null?void 0:ce.is_reject)!=null&&ue.title?"outline":""}`,type:"text"})}),((me=y.title)==null?void 0:me.message)&&e.jsx("p",{style:{paddingTop:"10px"},className:"err_msg",children:(Ne=(be=y.title)==null?void 0:be.message)==null?void 0:Ne.toString()}),e.jsx("div",{className:"tit_wrap mt_25",children:e.jsxs("h3",{className:"fs_20",children:["행사 분야 ",e.jsx("i",{className:"col_red",children:"*"})]})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsx(Oe,{name:"category",control:V,render:({field:{onChange:F,value:X}})=>{var se,te,D;return e.jsxs("select",{onChange:he=>{const _e=parseInt(he.target.value);F(_e)},defaultValue:"defalue",className:`w_767 ${(te=(se=h==null?void 0:h.data)==null?void 0:se.is_reject)!=null&&te.category?"outline":""}`,value:X,children:[e.jsx("option",{value:"defalue",disabled:!0,children:"카테고리 선택"}),w&&((D=w==null?void 0:w.data)==null?void 0:D.map(he=>e.jsx("option",{value:he.id,children:he.name},he.id)))]})}})}),e.jsx("div",{className:"tit_wrap mt_25",children:e.jsxs("h3",{className:"tit02",children:["대표 이미지 ",e.jsx("i",{className:"col_red",children:"*"})]})}),e.jsx("div",{className:"tit_wrap mt_4",children:e.jsx("p",{className:"fs_12",children:"메인페이지 및 상세페이지 내 노출할 대표 이미지를 등록해주세요."})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsxs("div",{className:"infomation_blue_box w_767",children:[e.jsxs("div",{className:"dis_flex gap5 fs_12 fw_600",children:[e.jsx("i",{className:"info_icon"}),e.jsx("span",{children:"대표 이미지 등록 가이드"})]}),e.jsxs("div",{className:"mt_8 fs_12 fw_500 pl_15",children:["· 10MB 이하의 JPG, JPEG, PNG 파일",e.jsx("br",{}),"· 해상도 360*510픽셀(세로형), 1280*674픽셀(가로형) / 72dpi 이상"]})]})}),e.jsxs("div",{className:"dis_flex mt_10 gap16",children:[e.jsxs("div",{className:`${(Te=(Ve=h==null?void 0:h.data)==null?void 0:Ve.is_reject)!=null&&Te.img?"outline":""}`,children:[e.jsx("input",{id:"img1",type:"file",accept:"image/png,image/jpg,image/jpeg",multiple:!1,...C("img1"),onChange:F=>{J(F,x,l)},className:"hide"}),e.jsxs("label",{htmlFor:"img1",className:"file_inp vertical preview_label",children:[g&&e.jsxs("span",{className:"preview_img",children:[e.jsx("span",{onClick:F=>{q(F,"img1",x,l)},className:"cancel_btn"}),e.jsx("img",{src:g})]}),"0 / 1"]}),e.jsx("p",{className:"txt_center fs_12 mt_7",children:"세로형"})]}),e.jsxs("div",{className:`${(ee=(I=h==null?void 0:h.data)==null?void 0:I.is_reject)!=null&&ee.img?"outline":""}`,children:[e.jsx("input",{id:"img2",type:"file",multiple:!1,accept:"image/png,image/jpg,image/jpeg",...C("img2"),onChange:F=>{J(F,u,f)},className:"hide"}),e.jsxs("label",{htmlFor:"img2",className:"file_inp horizontal preview_label",children:[m&&e.jsxs("span",{className:"preview_img",children:[e.jsx("span",{onClick:F=>{q(F,"img2",u,f)},className:"cancel_btn"}),e.jsx("img",{src:m})]}),"0 / 1"]}),e.jsx("p",{className:"txt_center fs_12 mt_7",children:"가로형"})]})]}),e.jsx("div",{className:"tit_wrap mt_25",children:e.jsxs("h3",{className:"fs_20",children:["행사 운영 일자 ",e.jsx("i",{className:"col_red",children:"*"})]})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsxs("div",{className:`dis_flex w_767 ${(Se=(re=h==null?void 0:h.data)==null?void 0:re.is_reject)!=null&&Se.date?"outline":""}`,children:[e.jsxs("div",{className:"date_inp_wrap flex1",children:[e.jsx("input",{className:"w_full",type:"text",placeholder:"행사 시작 일자를 선택해주세요.",...C("event_start_view"),onChange:F=>Z(F,"event_start_view")}),e.jsx("label",{htmlFor:"event_start_date"}),e.jsx("input",{id:"event_start_date",type:"date",...C("event_start_date"),onChange:F=>j("event_start_view",F.target.value)})]}),e.jsx("span",{className:"fs_20",children:" ~ "}),e.jsxs("div",{className:"date_inp_wrap flex1",children:[e.jsx("input",{type:"text",...C("event_end_view"),onChange:F=>Z(F,"event_end_view"),className:"w_full",placeholder:"행사 종료 일자를 선택해주세요."}),e.jsx("label",{htmlFor:"event_end_date"}),e.jsx("input",{id:"event_end_date",type:"date",...C("event_end_date"),onChange:F=>j("event_end_view",F.target.value)})]})]})}),((we=y.event_end_date)==null?void 0:we.message)&&e.jsx("p",{className:"err_msg",style:{paddingTop:"10px"},children:(Qe=(Re=y.event_end_date)==null?void 0:Re.message)==null?void 0:Qe.toString()}),e.jsx("div",{className:"tit_wrap mt_25",children:e.jsxs("h3",{className:"fs_20",children:["행사 운영 시간 ",e.jsx("i",{className:"col_red",children:"*"})]})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsxs("div",{className:`dis_flex w_767 ${(Q=(M=h==null?void 0:h.data)==null?void 0:M.is_reject)!=null&&Q.time?"outline":""}`,children:[e.jsx("div",{className:"num_inp_wrap flex1",children:e.jsx(Oe,{name:"event_start_time",control:V,render:({field:{onChange:F,value:X}})=>e.jsxs(e.Fragment,{children:[e.jsx(vt,{selected:X,onChange:se=>F(se),showTimeSelect:!0,showTimeSelectOnly:!0,timeIntervals:30,dateFormat:"HH:mm",timeFormat:"HH:mm",showTimeCaption:!1,placeholderText:"행사 시작 시간을 입력해주세요."}),e.jsx("span",{onClick:()=>W(A,"event_start_time"),className:"increase"}),e.jsx("span",{onClick:()=>P(A,"event_start_time"),className:"decrease"})]})})}),e.jsx("span",{className:"fs_20",children:" ~ "}),e.jsx("div",{className:"num_inp_wrap flex1",children:e.jsx(Oe,{name:"event_end_time",control:V,render:({field:{onChange:F,value:X}})=>e.jsxs(e.Fragment,{children:[e.jsx(vt,{selected:X,onChange:se=>F(se),showTimeSelect:!0,showTimeSelectOnly:!0,timeIntervals:30,dateFormat:"HH:mm",timeFormat:"HH:mm",showTimeCaption:!1,placeholderText:"행사 종료 시간을 입력해주세요."}),e.jsx("span",{onClick:()=>W(v,"event_end_time"),className:"increase"}),e.jsx("span",{onClick:()=>P(v,"event_end_time"),className:"decrease"})]})})})]})}),e.jsx("div",{className:"tit_wrap mt_25",children:e.jsxs("h3",{className:"fs_20",children:["비용 설정 ",e.jsx("i",{className:"col_red",children:"*"})]})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsxs("div",{className:"dis_flex justify_between w_767",children:[e.jsx(Oe,{name:"payable_type",control:V,render:({field:{onChange:F,value:X}})=>{var se,te;return e.jsxs("select",{onChange:D=>{const he=parseInt(D.target.value);F(he)},defaultValue:"defalue",className:`w_372 ${(te=(se=h==null?void 0:h.data)==null?void 0:se.is_reject)!=null&&te.payable?"outline":""}`,value:X,children:[e.jsx("option",{value:"defalue",disabled:!0}),Kd.map(D=>e.jsx("option",{value:D.type,children:D.name},D.type))]})}}),R===2&&e.jsx("div",{id:"_sel1",children:e.jsx("input",{type:"number",...C("payable_price2",{valueAsNumber:!0}),className:"w_372",placeholder:"현장 신청 비용을 입력해주세요."})}),R===4&&e.jsx("div",{id:"_sel1",children:e.jsx("input",{type:"number",...C("payable_price1",{valueAsNumber:!0}),className:"w_372",placeholder:"유료 사전 신청 기간의 비용을 입력해주세요."})})]})}),R===3&&e.jsxs("div",{id:"_sel2",children:[e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_25",children:e.jsxs("div",{className:"dis_flex justify_between w_767 gap23",children:[e.jsxs("div",{className:"date_inp_wrap flex1",children:[e.jsx("input",{className:"w_full",type:"text",placeholder:"유료 시작 날짜",...C("payable_start_view"),onChange:F=>Z(F,"payable_start_view")}),e.jsx("label",{htmlFor:"payable_start_view"}),e.jsx("input",{id:"payable_start_view",type:"date",...C("payable_start_date"),onChange:F=>j("payable_start_view",F.target.value)})]}),e.jsxs("div",{className:"date_inp_wrap flex1",children:[e.jsx("input",{className:"w_full",type:"text",placeholder:"유료 종료 날짜",...C("payable_end_view"),onChange:F=>Z(F,"payable_end_view")}),e.jsx("label",{htmlFor:"payable_end_date"}),e.jsx("input",{id:"payable_end_date",type:"date",...C("payable_end_date"),onChange:F=>j("payable_end_view",F.target.value)})]}),e.jsx("input",{type:"number",...C("payable_price1",{valueAsNumber:!0}),className:"w_372",placeholder:"유료 사전 신청 기간의 비용을 입력해주세요."})]})}),((le=y.payable_end_date)==null?void 0:le.message)&&e.jsx("p",{className:"err_msg",style:{paddingTop:"10px"},children:(Ce=(oe=y.payable_end_date)==null?void 0:oe.message)==null?void 0:Ce.toString()}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsx("input",{type:"text",...C("payable_price_url"),className:"w_767",placeholder:"외부 결제 및 홈페이지 url을 입력해주세요. (마이스메이트 서비스에선 별도에 결제 기능을 제공하고 있지 않습니다.)"})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_25",children:e.jsx("div",{className:"w_767 txt_center"})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_25",children:e.jsx("input",{type:"number",...C("payable_price2",{valueAsNumber:!0}),className:"w_372",placeholder:"현장 신청 비용을 입력해주세요."})})]}),R===4&&e.jsxs("div",{id:"_sel4",children:[e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_25",children:e.jsx("input",{type:"text",...C("payable_price_url"),className:"w_767",placeholder:"외부 결제 및 홈페이지 url을 입력해주세요. (마이스메이트 서비스에선 별도에 결제 기능을 제공하고 있지 않습니다.)"})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_25",children:e.jsx("div",{className:"w_767 txt_center"})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_25",children:e.jsx("input",{type:"number",...C("payable_price2",{valueAsNumber:!0}),className:"w_372",placeholder:"현장 신청 비용을 입력해주세요."})})]}),R===5&&e.jsx("div",{id:"_sel4",children:e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_25",children:e.jsx("input",{type:"text",className:"w_767",...C("payable_price_url"),placeholder:"외부 결제 및 홈페이지 url을 입력해주세요. (마이스메이트 서비스에선 별도에 결제 기능을 제공하고 있지 않습니다.)"})})}),e.jsx("div",{className:"tit_wrap mt_25",children:e.jsxs("h3",{className:"fs_20",children:["행사 진행 방식 ",e.jsx("i",{className:"col_red",children:"*"})]})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsxs("div",{className:`dis_flex w_767 gap11 ${(Le=(pe=h==null?void 0:h.data)==null?void 0:pe.is_reject)!=null&&Le.progress?"outline":""}`,children:[e.jsxs("div",{className:"checkbox02 flex1 col_gray",children:[e.jsx("input",{id:"0",...C("progress_type"),type:"radio",name:"progress_type",value:"0"}),e.jsx("label",{htmlFor:"0",children:"오프라인 행사"})]}),e.jsxs("div",{className:"checkbox02 flex1 col_gray",children:[e.jsx("input",{id:"1",...C("progress_type"),type:"radio",name:"progress_type",value:"1"}),e.jsx("label",{htmlFor:"1",children:"온라인 행사"})]}),e.jsxs("div",{className:"checkbox02 flex1 col_gray",children:[e.jsx("input",{id:"2",...C("progress_type"),type:"radio",name:"progress_type",value:"2"}),e.jsx("label",{htmlFor:"2",children:"하이브리드 행사"})]})]})}),(k==="1"||k==="2")&&e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_18",children:e.jsx("input",{className:"w_767",...C("progress_url"),type:"text",placeholder:"온라인 행사 url를 입력해주세요. (온라인 / 하이브리드 행사 선택 시)"})}),(k==="0"||k==="2")&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"tit_wrap mt_25",children:e.jsxs("h3",{className:"fs_20",children:["행사 운영 위치 ",e.jsx("i",{className:"col_red",children:"*"})]})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsx("input",{type:"text",...C("position1"),onClick:T,className:`w_767 ${(ot=(We=h==null?void 0:h.data)==null?void 0:We.is_reject)!=null&&ot.position?"outline":""}`,placeholder:"도로명/지번 주소 검색 (오프라인 / 하이브리드 행사 선택 시)"})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_18",children:e.jsx("input",{type:"text",...C("position2"),className:`w_767 ${(dt=(lt=h==null?void 0:h.data)==null?void 0:lt.is_reject)!=null&&dt.position?"outline":""}`,placeholder:"세부 주소"})})]}),e.jsxs("div",{className:"dis_flex justify_between mt_48",children:[e.jsx("div",{className:"btn_wrap"}),e.jsxs("div",{className:"btn_wrap gap23",children:[e.jsx("button",{onClick:()=>{r(!1)},className:"btn blue_bor",children:"임시 저장"}),e.jsx("button",{onClick:()=>{r(!0)},className:"btn dark_blue",children:"다음"})]})]})]})]})})},Xd=()=>{var y,A,v,R;const[t,i]=n.useState(""),[s,a]=n.useState([]),[r,d]=n.useState([]),[c,o]=n.useState(""),[l,p]=n.useState([]),{id:f}=ge(),x=Ue().authInfo,{data:m}=ba({token:x.token,event_id:f}),u=ja(),w=$(),_=n.useRef(null),{openToast:H}=ke(),L=ka(),z=Na();n.useEffect(()=>{var k,Z,J,q;(k=m==null?void 0:m.data)!=null&&k.content&&i(m.data.content),(Z=m==null?void 0:m.data)!=null&&Z.images&&a((J=m==null?void 0:m.data)==null?void 0:J.images),(q=m==null?void 0:m.data)!=null&&q.tags&&p(m.data.tags)},[m]);const B=k=>{const q=new DOMParser().parseFromString(k,"text/html").querySelectorAll("img");return Array.from(q).map(W=>W.src)},O=k=>{i(k);const Z=B(k),J=s.filter(q=>!Z.includes(`https://api.micemate.io/storage/${q.path}`)).map(q=>q.id);J.length>0&&d(q=>[...new Set([...q,...J])])},h=()=>{const k=document.createElement("input");k.setAttribute("type","file"),k.setAttribute("accept","image/png,image/jpg,image/jpeg"),k.click(),k.addEventListener("change",async()=>{const Z=k.files[0],J=new FormData;J.append("img",Z),L.mutate({token:x.token,event_id:f,formData:J},{onSuccess:q=>{var T;const W=`https://api.micemate.io/storage/${(T=q==null?void 0:q.data)==null?void 0:T.path}`,P=_.current.getEditor(),G=P.getSelection();P.insertEmbed(G.index,"image",W),P.setSelection({index:G.index+1,length:0})},onSettled:()=>e.jsx(Ae,{}),onError:()=>{}})})},C=n.useMemo(()=>({toolbar:{container:[[{header:"1"},{header:"2"}],[{size:[]}],["bold","italic","underline","strike","blockquote"],[{list:"ordered"},{list:"bullet"},{align:[]}],["image"]],handlers:{image:h}},clipboard:{matchVisual:!1}}),[]),S=["header","font","size","bold","italic","underline","strike","blockquote","list","bullet","align","image"],j=k=>{if(k.key==="Enter"){if(k.preventDefault(),k.nativeEvent.isComposing)return;l.length<5&&c.length>0&&(l.includes(c)?H("중복된 단어 입니다."):p(Z=>[...Z,c.trim()])),o("")}},N=k=>{p(Z=>Z.filter((J,q)=>q!==k))},V=k=>{const Z={content:t,tags:l};r.length>0&&z.mutate({token:x.token,event_id:f,data:{ids:r}}),u.mutate({token:x.token,event_id:f,data:Z},{onSuccess:()=>{k===!0&&w(`/host/my/apply-register/edit/${f}/application`),H("저장 되었습니다.")}})};return e.jsx("div",{className:"cont_area",children:e.jsxs("div",{className:"cont_panel type2",children:[e.jsx("div",{className:"tit_wrap",children:e.jsx("h2",{className:"fs_40 fw_700",children:"상세페이지"})}),e.jsx("div",{className:"tit_wrap mt_12",children:e.jsx("h3",{className:"fs_18",children:"행사 등록을 위한 내용을 작성해주세요."})}),e.jsx("div",{className:"tit_wrap mt_62",children:e.jsxs("h3",{className:"tit02",children:["행사 상세내용 ",e.jsx("i",{className:"col_red",children:"*"})]})}),e.jsx("div",{className:"tit_wrap mt_4",children:e.jsx("p",{className:"fs_12",children:"메인페이지 및 상세페이지 내 노출할 상세이미지 및 내용을 입력해주세요."})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsxs("div",{className:"infomation_blue_box w_767",children:[e.jsxs("div",{className:"dis_flex gap5 fs_12 fw_600",children:[e.jsx("i",{className:"info_icon"}),e.jsx("span",{children:"상세 내용 작성 가이드"})]}),e.jsxs("div",{className:"mt_8 fs_12 fw_500 pl_15",children:["· 이미지의 너비는 1100px 이상으로 등록해야 상세 페이지의 여백이 생기지 않습니다.",e.jsx("br",{}),"· 이미지는 png, jpg 확장자 파일만 가능하며 용량은 개당 10mb까지 업로드 가능합니다.",e.jsx("br",{}),"· 이미지 용량이 큰 경우 로딩 속도가 느려질 수 있습니다.",e.jsx("br",{}),"· 설명 글도 함께 작성할 수 있으니, 기본 정보 외의 추가할 세부 내용을 작성해주세요."]})]})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_20 ReactQuill",children:e.jsx("div",{className:`w_767 ${(A=(y=m==null?void 0:m.data)==null?void 0:y.is_reject)!=null&&A.content?"ounline":""}`,children:e.jsx(gs,{ref:_,value:t,onChange:O,modules:C,formats:S,className:"quill_editor",theme:"snow"})})}),e.jsx("div",{className:"tit_wrap mt_25",children:e.jsxs("h3",{className:"fs_20",children:["태그 ",e.jsx("i",{className:"col_red",children:"*"})]})}),e.jsx("div",{className:"tit_wrap mt_4",children:e.jsx("p",{className:"fs_12",children:"본 행사를 설명해줄 태그를 입력해주세요."})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsx("input",{type:"text",onChange:k=>{o(k.target.value)},onKeyDown:k=>j(k),value:c,className:`w_372 ${(R=(v=m==null?void 0:m.data)==null?void 0:v.is_reject)!=null&&R.tag?"outline":""}`,placeholder:"태그는 최대 5개까지 입력 가능합니다."})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_14",children:e.jsx("ul",{className:"white_tag_list",children:l&&l.map((k,Z)=>e.jsxs("li",{children:[k,e.jsx("button",{onClick:()=>N(Z),className:"delete_btn"})]},`${k}_${Z}`))})}),e.jsxs("div",{className:"dis_flex justify_between mt_48",children:[e.jsx("div",{className:"btn_wrap"}),e.jsxs("div",{className:"btn_wrap gap23",children:[e.jsx("button",{onClick:()=>V(!1),className:"btn blue_bor",children:"임시 저장"}),e.jsx("button",{onClick:()=>V(!0),className:"btn dark_blue",children:"다음"})]})]})]})})},Dd=()=>{var v,R,k,Z,J,q,W,P,G,T,K,ce,ue,me,be,Ne,Ve,Te,I,ee,re,Se,we,Re,Qe;const{openToast:t}=ke(),[i,s]=n.useState(!1),a=$(),d=Ue().authInfo,{id:c}=ge(),{data:o}=Yi({token:d.token,event_id:c}),{data:l}=Qt({token:d.token,event_id:c}),p=wa(),[f,g]=n.useState(),[x,m]=n.useState(),[u,w]=n.useState(),[_,H]=n.useState(),[L,z]=n.useState(),[B,O]=n.useState();n.useEffect(()=>{var M,Q,le,oe,Ce,pe,Le,We,ot,lt,dt,F,X,se,te,D,he,_e,Je;S("event_start_date",Ee((M=o==null?void 0:o.data)==null?void 0:M.application_start_date)),S("event_start_view",Ee((Q=o==null?void 0:o.data)==null?void 0:Q.application_start_date)),S("event_start_time",kt((le=o==null?void 0:o.data)==null?void 0:le.application_start_date)),S("event_end_date",Ee((oe=o==null?void 0:o.data)==null?void 0:oe.application_end_date)),S("event_end_view",Ee((Ce=o==null?void 0:o.data)==null?void 0:Ce.application_end_date)),S("event_end_time",kt((pe=o==null?void 0:o.data)==null?void 0:pe.application_end_date)),S("application_type",JSON.stringify((Le=o==null?void 0:o.data)==null?void 0:Le.application_type)),S("team",(We=o==null?void 0:o.data)==null?void 0:We.information[0].is_set),S("team_child",(ot=o==null?void 0:o.data)==null?void 0:ot.information[0].required),S("department",(lt=o==null?void 0:o.data)==null?void 0:lt.information[1].is_set),S("department_child",(dt=o==null?void 0:o.data)==null?void 0:dt.information[1].required),S("title",(F=o==null?void 0:o.data)==null?void 0:F.information[2].is_set),S("title_child",(X=o==null?void 0:o.data)==null?void 0:X.information[2].required),S("gender",(se=o==null?void 0:o.data)==null?void 0:se.information[3].is_set),S("gender_child",(te=o==null?void 0:o.data)==null?void 0:te.information[3].required),S("age",(D=o==null?void 0:o.data)==null?void 0:D.information[4].is_set),S("age_child",(he=o==null?void 0:o.data)==null?void 0:he.information[4].required),S("residence",(_e=o==null?void 0:o.data)==null?void 0:_e.information[5].is_set),S("residence_child",(Je=o==null?void 0:o.data)==null?void 0:Je.information[5].required)},[o]);const{register:h,handleSubmit:C,setValue:S,setError:j,control:N,formState:{errors:V}}=ve(),y=(M,Q)=>{Ft(M,S,Q)},A=C(M=>{var pe;if(M.event_start_date&&M.event_end_date&&M.event_start_date>M.event_end_date){j("event_end_view",{type:"manual",message:"종료 날짜는 시작 날짜 이후여야 합니다."});return}if(((pe=l==null?void 0:l.data)==null?void 0:pe.event_end_date)<M.event_end_date){j("event_end_view",{type:"manual",message:"모집 기간은 행사 종료일 이후 일 수 없습니다."});return}const Q=Nt(M.event_start_time),le=Nt(M.event_end_time);let oe={};M.team&&(oe={...oe,1:M.team_child??!1}),M.department&&(oe={...oe,2:M.department_child??!1}),M.title&&(oe={...oe,3:M.title_child??!1}),M.gender&&(oe={...oe,4:M.gender_child??!1}),M.age&&(oe={...oe,5:M.age_child??!1}),M.residence&&(oe={...oe,6:M.residence_child??!1});const Ce={information:oe,...M.event_start_view&&Q&&{application_start_date:`${M.event_start_view} ${Q}`},...M.event_end_view&&le&&{application_end_date:`${M.event_end_view} ${le}`},...M.application_type&&{application_type:M.application_type}};i===!0?p.mutate({token:d.token,event_id:c,data:Ce},{onSuccess:()=>{a(`/host/my/apply-register/edit/${c}/survey`)}}):i===!1&&p.mutate({token:d.token,event_id:c,data:Ce},{onSuccess:()=>{t("저장 되었습니다.")}})});return e.jsx("div",{className:"cont_area",children:e.jsxs("div",{className:"cont_panel type2",children:[e.jsx("div",{className:"tit_wrap",children:e.jsx("h2",{className:"fs_40 fw_700",children:"모집정보"})}),e.jsx("div",{className:"tit_wrap mt_12",children:e.jsx("h3",{className:"fs_18",children:"행사 신청을 위해 모집 방법 및 수집할 정보를 입력해주세요."})}),e.jsxs("form",{onSubmit:A,children:[e.jsx("div",{className:"tit_wrap mt_62",children:e.jsxs("h3",{className:"fs_20",children:["모집 기간 ",e.jsx("i",{className:"col_red",children:"*"})]})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsxs("div",{className:`w_767 dis_flex gap10 ${(R=(v=o==null?void 0:o.data)==null?void 0:v.is_reject)!=null&&R.application_date?"outline":""}`,children:[e.jsxs("div",{className:"date_inp_wrap flex1",children:[e.jsx("input",{...h("event_start_view"),onChange:M=>y(M,"event_start_view"),type:"text",className:"w_full",placeholder:"시작 날짜"}),e.jsx("label",{htmlFor:"event_start_date"}),e.jsx("input",{id:"event_start_date",type:"date",...h("event_start_date"),onChange:M=>S("event_start_view",M.target.value)})]}),e.jsx("div",{className:"flex1",children:e.jsx(Oe,{name:"event_start_time",control:N,render:({field:{onChange:M,value:Q}})=>e.jsx(e.Fragment,{children:e.jsx(vt,{selected:Q,onChange:le=>M(le),showTimeSelect:!0,showTimeSelectOnly:!0,timeIntervals:30,dateFormat:"HH:mm",timeFormat:"HH:mm",showTimeCaption:!1,placeholderText:"시작 시간",className:"w_full"})})})}),e.jsxs("div",{className:"date_inp_wrap flex1",children:[e.jsx("input",{type:"text",...h("event_end_view"),onChange:M=>y(M,"event_end_view"),className:"w_full",placeholder:"종료 날짜"}),e.jsx("label",{htmlFor:"event_end_date"}),e.jsx("input",{id:"event_end_date",type:"date",...h("event_end_date"),onChange:M=>S("event_end_view",M.target.value)})]}),e.jsx("div",{className:"flex1",children:e.jsx(Oe,{name:"event_end_time",control:N,render:({field:{onChange:M,value:Q}})=>e.jsx(e.Fragment,{children:e.jsx(vt,{selected:Q,onChange:le=>M(le),showTimeSelect:!0,showTimeSelectOnly:!0,timeIntervals:30,dateFormat:"HH:mm",timeFormat:"HH:mm",showTimeCaption:!1,placeholderText:"종료 시간",className:"w_full"})})})})]})}),((k=V.event_end_date)==null?void 0:k.message)&&e.jsx("p",{className:"err_msg",style:{paddingTop:"10px"},children:(J=(Z=V.event_end_date)==null?void 0:Z.message)==null?void 0:J.toString()}),e.jsx("div",{className:"tit_wrap mt_25",children:e.jsxs("h3",{className:"fs_20",children:["모집 방법 ",e.jsx("i",{className:"col_red",children:"*"})]})}),e.jsx("div",{className:"tit_wrap mt_4",children:e.jsx("h3",{className:"fs_12",children:"단체 신청 진행 시, 선택하신 수집 정보를 기반으로 한 엑셀 양식을 제공합니다."})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsxs("div",{className:`dis_flex w_767 gap11 ${(W=(q=o==null?void 0:o.data)==null?void 0:q.is_reject)!=null&&W.application_type?"outline":""}`,children:[e.jsxs("div",{className:"checkbox02 flex1",children:[e.jsx("input",{id:"0",...h("application_type"),type:"radio",name:"application_type",value:"0"}),e.jsx("label",{htmlFor:"0",children:"개인 신청"})]}),e.jsxs("div",{className:"checkbox02 flex1",children:[e.jsx("input",{id:"1",...h("application_type"),type:"radio",name:"application_type",value:"1"}),e.jsx("label",{htmlFor:"1",children:"단체 신청"})]}),e.jsxs("div",{className:"checkbox02 flex1",children:[e.jsx("input",{id:"2",...h("application_type"),type:"radio",name:"application_type",value:"2"}),e.jsx("label",{htmlFor:"2",children:"개인/단체 신청 모두"})]})]})}),e.jsx("div",{className:"tit_wrap mt_25",children:e.jsxs("h3",{className:"fs_20",children:["수집 정보 ",e.jsx("i",{className:"col_red",children:"*"})]})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsxs("div",{className:"checkbox02 w_767",children:[e.jsx("input",{id:"chk03_1",type:"checkbox",disabled:!0,checked:!0}),e.jsx("label",{htmlFor:"chk03_1",className:`${(G=(P=o==null?void 0:o.data)==null?void 0:P.is_reject)!=null&&G.application_information?"outline":""}`,children:"이름"})]})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsxs("div",{className:"checkbox02 w_767",children:[e.jsx("input",{id:"chk03_2",type:"checkbox",disabled:!0,checked:!0}),e.jsx("label",{htmlFor:"chk03_2",className:`${(K=(T=o==null?void 0:o.data)==null?void 0:T.is_reject)!=null&&K.application_information?"outline":""}`,children:"이메일"})]})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsxs("div",{className:"checkbox02 w_767",children:[e.jsx("input",{id:"chk03_3",type:"checkbox",disabled:!0,checked:!0}),e.jsx("label",{htmlFor:"chk03_3",className:`${(ue=(ce=o==null?void 0:o.data)==null?void 0:ce.is_reject)!=null&&ue.application_information?"outline":""}`,children:"휴대전화 번호"})]})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsxs("div",{className:"checkbox_toggle w_767",children:[e.jsx("input",{...h("team"),id:"chk03_4",type:"checkbox",className:"input",value:"1",onChange:M=>{g(M.target.checked),M.target.checked===!1&&S("team_child",!1)}}),e.jsx("label",{htmlFor:"chk03_4",className:`label ${(be=(me=o==null?void 0:o.data)==null?void 0:me.is_reject)!=null&&be.application_information?"outline":""}`,children:"소속 (회사/기관/학교명)"}),e.jsx("input",{...h("team_child"),type:"checkbox",className:"hide toggle",id:"team_child",disabled:!f}),e.jsxs("label",{htmlFor:"team_child",className:"required_toggle_btn",children:["필수",e.jsx("i",{})]})]})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsxs("div",{className:"checkbox_toggle w_767",children:[e.jsx("input",{...h("department"),id:"chk03_5",type:"checkbox",className:"input",value:"2",onChange:M=>{m(M.target.checked),M.target.checked===!1&&S("department_child",!1)}}),e.jsx("label",{htmlFor:"chk03_5",className:`label ${(Ve=(Ne=o==null?void 0:o.data)==null?void 0:Ne.is_reject)!=null&&Ve.application_information?"outline":""}`,children:"부서"}),e.jsx("input",{...h("department_child"),type:"checkbox",className:"hide toggle",id:"department_child",disabled:!x}),e.jsxs("label",{htmlFor:"department_child",className:"required_toggle_btn",children:["필수",e.jsx("i",{})]})]})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsxs("div",{className:"checkbox_toggle w_767",children:[e.jsx("input",{...h("title"),id:"title",type:"checkbox",className:"input",value:"3",onChange:M=>{w(M.target.checked),M.target.checked===!1&&S("title_child",!1)}}),e.jsx("label",{htmlFor:"title",className:`label ${(I=(Te=o==null?void 0:o.data)==null?void 0:Te.is_reject)!=null&&I.application_information?"outline":""}`,children:"직함"}),e.jsx("input",{...h("title_child"),type:"checkbox",className:"hide toggle",id:"title_child",disabled:!u}),e.jsxs("label",{htmlFor:"title_child",className:"required_toggle_btn",children:["필수",e.jsx("i",{})]})]})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsxs("div",{className:"checkbox_toggle w_767",children:[e.jsx("input",{...h("gender"),id:"chk03_7",type:"checkbox",className:"input",value:"4",onChange:M=>{H(M.target.checked),M.target.checked===!1&&S("gender_child",!1)}}),e.jsx("label",{htmlFor:"chk03_7",className:`label ${(re=(ee=o==null?void 0:o.data)==null?void 0:ee.is_reject)!=null&&re.application_information?"outline":""}`,children:"성별"}),e.jsx("input",{...h("gender_child"),type:"checkbox",className:"hide toggle",id:"gender_child",disabled:!_}),e.jsxs("label",{htmlFor:"gender_child",className:"required_toggle_btn ",children:["필수",e.jsx("i",{})]})]})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsxs("div",{className:"checkbox_toggle w_767",children:[e.jsx("input",{...h("age"),id:"age",type:"checkbox",className:"input",value:"5",onChange:M=>{z(M.target.checked),M.target.checked===!1&&S("age_child",!1)}}),e.jsx("label",{htmlFor:"age",className:`label ${(we=(Se=o==null?void 0:o.data)==null?void 0:Se.is_reject)!=null&&we.application_information?"outline":""}`,children:"나이"}),e.jsx("input",{...h("age_child"),type:"checkbox",className:"hide toggle",id:"age_child",disabled:!L}),e.jsxs("label",{htmlFor:"age_child",className:"required_toggle_btn",children:["필수",e.jsx("i",{})]})]})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsxs("div",{className:"checkbox_toggle w_767",children:[e.jsx("input",{...h("residence"),id:"residence",type:"checkbox",className:"input",value:"6",onChange:M=>{O(M.target.checked),M.target.checked===!1&&S("residence_child",!1)}}),e.jsx("label",{htmlFor:"residence",className:`label ${(Qe=(Re=o==null?void 0:o.data)==null?void 0:Re.is_reject)!=null&&Qe.application_information?"outline":""}`,children:"거주 지역"}),e.jsx("input",{...h("residence_child"),type:"checkbox",className:"hide toggle",id:"residence_child",disabled:!B}),e.jsxs("label",{htmlFor:"residence_child",className:"required_toggle_btn",children:["필수",e.jsx("i",{})]})]})}),e.jsxs("div",{className:"dis_flex justify_between mt_48",children:[e.jsx("div",{className:"btn_wrap"}),e.jsxs("div",{className:"btn_wrap gap23",children:[e.jsx("button",{onClick:()=>s(!1),className:"btn blue_bor",children:"저장"}),e.jsx("button",{onClick:()=>s(!0),className:"btn dark_blue",children:"다음"})]})]})]})]})})},$d=ne.object({is_survey:ne.boolean(),surveys:ne.array(ne.object({type:ne.union([ne.literal(0),ne.literal(1),ne.literal(2)],{invalid_type_error:"설문 유형이 유효하지 않습니다."}),title:ne.string().min(1,{message:"설문 제목을 입력해주세요."}).max(50,{message:"설문 제목은 최대 50자입니다."}),options:ne.array(ne.string().min(1,{message:"옵션을 입력해주세요."}).max(20,{message:"옵션 텍스트는 20자를 초과할 수 없습니다."})).max(10,{message:"옵션은 최대 10개까지 추가할 수 있습니다."}).optional(),required:ne.boolean(),is_reject:ne.boolean()}).superRefine((t,i)=>{(t.type===0||t.type===1)&&(!t.options||t.options.length<1)&&i.addIssue({path:["options"],code:ne.ZodIssueCode.custom,message:"옵션을 최소 1개 이상 입력해주세요."})})).max(5,{message:"최대 5개의 설문을 추가할 수 있습니다."}).optional(),is_reject:ne.object({survey:ne.boolean()})}).superRefine((t,i)=>{t.is_survey?(!t.surveys||t.surveys.length===0)&&i.addIssue({path:["surveys"],code:ne.ZodIssueCode.custom,message:"is_survey가 true일 때는 최소 1개의 설문이 필요합니다."}):t.surveys&&t.surveys.length>0&&i.addIssue({path:["surveys"],code:ne.ZodIssueCode.custom,message:"is_survey가 false일 때는 설문을 추가할 수 없습니다."})}),ec=()=>{const{id:t}=ge(),{authInfo:i}=Ue(),{data:s}=_a({token:i.token,event_id:t}),[a,r]=n.useState(!0),[d,c]=n.useState([]),[o,l]=n.useState([]),[p,f]=n.useState({}),[g,x]=n.useState(!1),{mutate:m}=ya(),{openToast:u}=ke(),w=$();n.useEffect(()=>{if(s&&s.success){x(s.data.is_reject.survey);const{is_survey:j,surveys:N}=s.data;if(r(j!==void 0?j:!0),j===!0&&N.length>0){const V=N.map(y=>({type:y.type,title:y.title,options:y.type===0||y.type===1?y.options.map(A=>({text:A})):[],required:y.required,isReject:y.is_reject}));c(V),l(V)}else j==!0?l([_]):l([])}},[s]);const _={type:0,title:"",options:[{text:""}],required:!1,isReject:!1},H=()=>{if(o.length>=5){u("최대 5개의 설문을 추가할 수 있습니다.");return}l([...o,{type:0,title:"",options:[{text:""}],required:!0,isReject:!1}])},L=j=>{if(o.length===1)return;const N=[...o];N.splice(j,1),l(N)},z=(j,N,V)=>{const y=[...o];y[j][N]=V,l(y)},B=j=>{if(o[j].options.length>=10){u("옵션은 최대 10개까지 추가할 수 있습니다.");return}const V=[...o];V[j].options.push({text:""}),l(V)},O=(j,N)=>{const V=[...o];V[j].options.length!==1&&(V[j].options.splice(N,1),l(V))},h=(j,N,V)=>{const y=[...o];y[j].options[N].text=V,l(y)},C=j=>{l([]),r(j),j?d.length>0?l(d):l([_]):l([])},S=j=>{const N={is_survey:a,surveys:o.map(y=>({type:y.type,title:y.title,options:y.type===0||y.type===1?y.options.map(A=>A.text):[],required:y.required,is_reject:!1})),is_reject:{survey:!1}};console.log("API 데이터:",N);const V=$d.safeParse(N);if(!V.success){const y={};V.error.errors.forEach(A=>{const v=A.path,R=A.message;if(v[0]==="surveys"&&typeof v[1]=="number"){const k=v[1],Z=v[2];if(y.surveys||(y.surveys=[]),y.surveys[k]||(y.surveys[k]={}),Z==="options"&&v.length>3){const J=v[3];y.surveys[k].options||(y.surveys[k].options=[]),y.surveys[k].options[J]=R}}else v[0]==="is_reject"&&v[1]==="survey"?y.is_reject={survey:R}:v[0]==="is_survey"&&(y.is_survey=R)}),f(y),console.log(V.error),u("입력하지 않은 항목이 있습니다.");return}f({}),m({token:i.token,event_id:t,data:N},{onSuccess:()=>j?u("임시저장 되었습니다."):w(`/host/my/apply-register/edit/${t}/faq`),onError:y=>{console.error("Mutation failed:",y),u("저장 중 오류가 발생했습니다.")}})};return e.jsx("div",{className:"cont_area",children:e.jsxs("div",{className:"cont_panel type2",children:[e.jsx("div",{className:"tit_wrap",children:e.jsx("h2",{className:"fs_40",children:"사전 설문"})}),e.jsx("div",{className:"tit_wrap mt_12",children:e.jsx("h3",{className:"fs_18",children:"사전 설문 제작을 통해 행사에 필요한 데이터를 받아보세요."})}),e.jsx("div",{className:"tit_wrap mt_62",children:e.jsx("h3",{className:"fs_20",children:"사전 설문 사용 여부"})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsxs("div",{className:"dis_flex w_767 gap32",children:[e.jsxs("div",{className:"checkbox02 flex1",children:[e.jsx("input",{id:"useSurvey_yes",type:"radio",name:"useSurvey",value:"yes",checked:a,onChange:()=>C(!0)}),e.jsx("label",{htmlFor:"useSurvey_yes",className:g?"outline":"",children:"사용함"})]}),e.jsxs("div",{className:"checkbox02 flex1",children:[e.jsx("input",{id:"useSurvey_no",type:"radio",name:"useSurvey",value:"no",checked:!a,onChange:()=>C(!1)}),e.jsx("label",{htmlFor:"useSurvey_no",className:g?"outline":"",children:"사용하지 않음"})]})]})}),a&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"tit_wrap mt_55",children:e.jsx("h3",{className:"fs_20",children:"설문 리스트"})}),o.map((j,N)=>{var V;return e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_14",children:e.jsxs("div",{className:j.isReject?"survey_card w_767 outline":"survey_card w_767",children:[e.jsxs("div",{className:"head",children:[e.jsx("input",{type:"text",placeholder:"설문 제목을 입력해주세요.",value:j.title,onChange:y=>z(N,"title",y.target.value),maxLength:50,className:(V=p.surveys)!=null&&V[N]?"red":""}),e.jsxs("select",{value:j.type,onChange:y=>z(N,"type",Number(y.target.value)),children:[e.jsx("option",{value:0,children:"단일 선택"}),e.jsx("option",{value:1,children:"다중 선택"}),e.jsx("option",{value:2,children:"장문"})]})]}),(j.type===0||j.type===1)&&e.jsxs("div",{className:"body",children:[j.options.map((y,A)=>{var v,R,k;return e.jsx("div",{className:"option_item",children:e.jsxs("div",{className:"option_input",children:[e.jsx("input",{type:"text",placeholder:"옵션을 입력해주세요.",value:y.text,onChange:Z=>h(N,A,Z.target.value),maxLength:20,className:(k=(R=(v=p.surveys)==null?void 0:v[N])==null?void 0:R.options)!=null&&k[A]?"red":""}),j.options.length>1&&e.jsx("button",{type:"button",onClick:()=>O(N,A),className:"remove_option_btn",children:"X"})]})},A)}),e.jsx("button",{type:"button",onClick:()=>B(N),className:`option_add_btn ${j.options.length>=10?"disabled":""}`,disabled:j.options.length>=10,children:"옵션 추가"})]}),e.jsxs("div",{className:"btm",children:[e.jsx("button",{type:"button",onClick:()=>L(N),className:"delete_btn"}),e.jsx("i",{className:"bor_line"}),e.jsxs("button",{type:"button",onClick:()=>z(N,"required",!j.required),className:`required_toggle_btn ${j.required?"active":""}`,children:["필수",e.jsx("i",{})]})]})]})},N)}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_25",children:e.jsx("div",{className:"w_767 dis_flex justify_end",children:e.jsx("button",{type:"button",onClick:H,className:`btn h_36 dark_blue ${o.length>=5?"disabled":""}`,disabled:o.length>=5,children:"추가하기"})})})]}),e.jsxs("div",{className:"dis_flex justify_between mt_48",children:[e.jsx("div",{className:"btn_wrap"}),e.jsxs("div",{className:"btn_wrap gap23",children:[e.jsx("button",{type:"button",className:"btn blue_bor",onClick:()=>S(!0),children:"임시 저장"}),e.jsx("button",{type:"button",className:"btn dark_blue",onClick:()=>S(!1),children:"다음"})]})]})]})})},tc=ne.object({question:ne.string().min(1,"질문을 입력해주세요.").max(50,"질문은 최대 50자입니다."),answer:ne.string().min(1,"답변을 입력해주세요.").max(100,"답변은 최대 100자입니다.")}),ic=ne.object({is_FAQ:ne.boolean(),faqs:ne.array(tc).max(5,"최대 5개의 FAQ를 추가할 수 있습니다.").optional(),contact_name:ne.string().min(1,"이름을 입력해주세요.").max(50,"이름은 최대 50자입니다."),contact_email:ne.string().email("유효한 이메일을 입력해주세요."),contact_number:ne.string().min(1,"휴대전화 번호를 입력해주세요.").regex(/^[0-9\-+\s()]*$/,"유효한 전화번호를 입력해주세요.")}).superRefine((t,i)=>{t.is_FAQ?(!t.faqs||t.faqs.length===0)&&i.addIssue({code:ne.ZodIssueCode.custom,message:"is_FAQ가 true일 때는 최소 1개의 FAQ가 필요합니다.",path:["faqs"]}):t.faqs&&t.faqs.length>0&&i.addIssue({code:ne.ZodIssueCode.custom,message:"is_FAQ가 false일 때는 faqs가 비어 있어야 합니다.",path:["faqs"]})}),sc=()=>{const{id:t}=ge(),{authInfo:i}=Ue(),{data:s}=va({token:i.token,event_id:t}),a=Pi(),[r,d]=n.useState(!0),[c,o]=n.useState([]),[l,p]=n.useState([]),[f,g]=n.useState({contact_name:"",contact_email:"",contact_number:""}),[x,m]=n.useState(!1),[u,w]=n.useState(!1),{mutate:_}=Ca(),[H,L]=n.useState({}),{openToast:z}=ke(),B=$();n.useEffect(()=>{if(s&&s.success){m(s.data.is_reject.faq),w(s.data.is_reject.contact);const{is_FAQ:A,faqs:v,contact_name:R,contact_email:k,contact_number:Z}=s.data;if(d(A!==void 0?A:!0),g({contact_name:R,contact_email:k,contact_number:Z}),A===!0&&v.length>0){const q=v.map(P=>({question:P.question,answer:P.answer,required:P.required,is_reject:P.is_reject})),W={contact_name:R,contact_email:k,contact_number:Z};o(q),p(q),g(W)}else p(A===!0?[O]:[])}},[s]);const O={question:"",answer:"",required:!0,is_reject:!1},h=()=>{if(l.length>=5){z("최대 5개의 FAQ를 추가할 수 있습니다.");return}p([...l,{question:"",answer:"",required:!0,is_reject:!1}])},C=A=>{if(l.length===1){z("최소 1개의 FAQ는 있어야 합니다.");return}const v=[...l];v.splice(A,1),p(v)},S=(A,v,R)=>{const k=[...l];k[A][v]=R,p(k)},j=A=>{const{name:v,value:R}=A.target;g(k=>({...k,[v]:R}))},N=A=>{p([]),d(A),A?c.length>0?p(c):p([O]):p([])},V=()=>{a.mutate({token:i.token,event_id:t},{onSuccess:()=>{B("/host/my/apply-register/edit/finish")},onError:()=>{z("작성중인 필드가 있습니다.")}})},y=A=>{const v={is_FAQ:r,faqs:l.map(R=>({question:R.question,answer:R.answer,is_reject:!1})),contact_name:f.contact_name||"",contact_email:f.contact_email||"",contact_number:f.contact_number||"",is_reject:{faq:!1,contact:!1}};console.log("API   : ",v);try{ic.parse(v),L({})}catch(R){if(R instanceof ne.ZodError){const k={};R.errors.forEach(Z=>{const J=Z.path,q=Z.message;if(J[0]==="faqs"&&typeof J[1]=="number"){const W=J[1];k.faqs||(k.faqs=[]),k.faqs[W]||(k.faqs[W]={}),J[2]==="question"&&(k.faqs[W].question=q),J[2]==="answer"&&(k.faqs[W].answer=q)}else{const W=J[0];W==="contact_name"&&(k.contact_name=q),W==="contact_email"&&(k.contact_email=q),W==="contact_number"&&(k.contact_number=q),W==="is_FAQ"&&(k.is_FAQ=q)}}),L(k),console.log(R),z("입력하지 않은 항목이 있습니다.");return}z("예기치 못한 오류가 발생했습니다.");return}_({token:i.token,event_id:t,data:v},{onSuccess:()=>{A?z("FAQ가 성공적으로 저장되었습니다."):V()},onError:R=>{console.error("Mutation failed:",R)}})};return e.jsx("div",{className:"cont_area",children:e.jsxs("div",{className:"cont_panel type2",children:[e.jsx("div",{className:"tit_wrap",children:e.jsx("h2",{className:"fs_40",children:"FAQ & 문의"})}),e.jsx("div",{className:"tit_wrap mt_12",children:e.jsx("h3",{className:"fs_18",children:"참가자 문의에 대한 담당자 정보를 입력해주세요."})}),e.jsx("div",{className:"tit_wrap mt_62",children:e.jsx("h3",{className:"fs_20",children:"FAQ 사용 여부"})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsxs("div",{className:"dis_flex w_767 gap32",children:[e.jsxs("div",{className:"checkbox02 flex1",children:[e.jsx("input",{id:"faq_use_yes",type:"radio",name:"faqUsage",checked:r,onChange:()=>N(!0)}),e.jsx("label",{htmlFor:"faq_use_yes",className:x?"outline":"",children:"사용함"})]}),e.jsxs("div",{className:"checkbox02 flex1",children:[e.jsx("input",{id:"faq_use_no",type:"radio",name:"faqUsage",checked:!r,onChange:()=>N(!1)}),e.jsx("label",{htmlFor:"faq_use_no",className:x?"outline":"",children:"사용하지 않음"})]})]})}),r&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"tit_wrap mt_55",children:e.jsx("h3",{className:"fs_20",children:"FAQ 리스트"})}),l.map((A,v)=>{var R,k;return e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_14",children:e.jsxs("div",{className:A.is_reject?"survey_card w_767 outline":"survey_card w_767",children:[e.jsx("div",{className:"head",children:e.jsx("input",{className:H.faqs&&((R=H.faqs[v])!=null&&R.question)?"red":"",type:"text",id:`question-${v}`,name:"question",value:A.question,onChange:Z=>S(v,"question",Z.target.value),maxLength:50,placeholder:"질문을 입력해주세요.",required:!0})}),e.jsx("div",{className:"body",children:e.jsx("input",{className:H.faqs&&((k=H.faqs[v])!=null&&k.answer)?"red":"",id:`answer-${v}`,type:"text",name:"answer",value:A.answer,onChange:Z=>S(v,"answer",Z.target.value),maxLength:100,placeholder:"답변을 입력해주세요.",required:!0})}),e.jsx("div",{className:"btm",children:e.jsx("button",{type:"button",onClick:()=>C(v),className:"delete_btn","aria-label":`FAQ ${v+1} 삭제`})})]})},v)}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_25",children:e.jsx("div",{className:"w_767 dis_flex justify_end",children:e.jsx("button",{type:"button",onClick:h,className:"btn h_36 dark_blue",disabled:l.length>=5,children:"추가하기"})})})]}),e.jsx("div",{className:"tit_wrap mt_55",children:e.jsxs("h3",{className:"fs_20",children:["문의 담당자 ",e.jsx("i",{className:"col_red",children:"*"})]})}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10",children:e.jsx("input",{className:u?"w_767 outline":"w_767",type:"text",name:"contact_name",value:f.contact_name,onChange:j,placeholder:"이름",maxLength:50,required:!0})}),H.contact_name&&e.jsx("p",{className:"err_msg_mt",children:H.contact_name}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10 mb-2",children:e.jsx("input",{className:u?"w_767 outline":"w_767",type:"email",name:"contact_email",value:f.contact_email,onChange:j,placeholder:"이메일",required:!0})}),H.contact_email&&e.jsx("p",{className:"err_msg_mt",children:H.contact_email}),e.jsx("div",{className:"dis_flex align_start justify_between pr_52 mt_10 mb-2",children:e.jsx("input",{className:u?"w_767 outline":"w_767",type:"tel",name:"contact_number",value:f.contact_number,onChange:j,placeholder:"휴대전화 번호",required:!0})}),H.contact_number&&e.jsx("p",{className:"err_msg_mt",children:H.contact_number}),e.jsxs("div",{className:"dis_flex justify_between mt_48 mb-2",children:[e.jsx("div",{className:"btn_wrap"}),e.jsxs("div",{className:"btn_wrap gap23",children:[e.jsx("button",{type:"submit",className:"btn dark_blue",onClick:()=>y(!0),children:"저장"}),e.jsx("button",{type:"button",className:"btn dark_blue",onClick:()=>y(!1),children:"행사 게시"})]})]})]})})},nc=({applyId:t,setDetailPopUp:i})=>{var c,o,l,p,f,g,x,m,u,w;const s=localStorage.getItem("token"),{id:a}=ge(),{data:r}=ca(a,s,t),d=()=>{i(!1)};return e.jsx(e.Fragment,{children:r&&e.jsxs("div",{className:"modal_wrap detailPop detailPop01",children:[e.jsx("div",{className:"dim_layer"}),e.jsxs("div",{className:"modal_inner",children:[e.jsx("button",{onClick:d,className:"modal_close"}),e.jsxs("div",{className:"modal_body",children:[e.jsx("div",{className:"modal_tit",children:"사전 설문 결과"}),e.jsx("div",{className:"fs_18 fw_600 mt_48",children:"신청자 정보"}),e.jsxs("ul",{className:"key_val_list mt_24",children:[e.jsxs("li",{children:[e.jsx("div",{className:"key",children:"신청 유형"}),e.jsx("div",{className:"val",children:((c=r==null?void 0:r.data)==null?void 0:c.type)===0?"개인 신청":"단체 신청"})]}),e.jsxs("li",{children:[e.jsx("div",{className:"key",children:"이름"}),e.jsx("div",{className:"val",children:(o=r==null?void 0:r.data)==null?void 0:o.name})]}),e.jsxs("li",{children:[e.jsx("div",{className:"key",children:"이메일"}),e.jsx("div",{className:"val",children:(l=r==null?void 0:r.data)==null?void 0:l.email})]}),e.jsxs("li",{children:[e.jsx("div",{className:"key",children:"휴대전화"}),e.jsx("div",{className:"val",children:(p=r==null?void 0:r.data)==null?void 0:p.contact})]}),((f=r==null?void 0:r.data)==null?void 0:f.information)&&((g=r==null?void 0:r.data)==null?void 0:g.information.map((_,H)=>e.jsxs("li",{children:[e.jsx("div",{className:"key",children:_==null?void 0:_.name}),e.jsx("div",{className:"val",children:_==null?void 0:_.answer})]},H))),((x=r==null?void 0:r.data)==null?void 0:x.surveys.length)>0&&e.jsx("div",{className:"fs_18 fw_600 mt_48",children:"사전 설문"}),((m=r==null?void 0:r.data)==null?void 0:m.surveys)&&((u=r==null?void 0:r.data)==null?void 0:u.surveys.map(_=>{var H;return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"fs_16 fw_600 mt_16",children:_.title}),_.type===0&&((H=_==null?void 0:_.options)==null?void 0:H.map((L,z)=>{const B=`rad-${z}`,O=`rad-${z}`;return e.jsx("div",{className:"mt_7",children:e.jsxs("div",{className:"radio02",children:[e.jsx("input",{id:B,type:"radio",name:O,checked:_.answer.includes(z),readOnly:!0}),e.jsx("label",{htmlFor:B,children:L})]})},z)})),_.type===1&&_.options.map((L,z)=>{const B=`chk00_01 ${z}`;return e.jsx("div",{className:"mt_7",children:e.jsxs("div",{className:"radio02",children:[e.jsx("input",{id:B,type:"checkbox",checked:_.answer.includes(String(z)),readOnly:!0}),e.jsx("label",{htmlFor:B,children:L})]})},z)}),_.type===2&&e.jsx("li",{children:e.jsx("div",{className:"val",children:_.answer})})]})}))]}),((w=r==null?void 0:r.data)==null?void 0:w.xlsx)!==null&&e.jsx("a",{href:`https://api.micemate.io/storage/${r.data.xlsx}`,style:{backgroundColor:"#1E9EFF",padding:"6px 10px",borderRadius:"5px",display:"block",width:"180px",textAlign:"center",margin:"64px auto 0",fontSize:"16px"},children:"참가자 엑셀 다운로드"})]})]})]})})},ac=({partyList:t})=>{const[i,s]=n.useState(!1),[a,r]=n.useState(null),d=c=>{r(c),s(!0)};return e.jsxs("div",{className:"table_wrap mt_22",children:[(t==null?void 0:t.total)>0?e.jsxs("table",{className:"type1",children:[e.jsxs("colgroup",{children:[e.jsx("col",{width:"130px"}),e.jsx("col",{width:"130px"}),e.jsx("col",{width:"130px"}),e.jsx("col",{width:"150px"}),e.jsx("col",{width:"160px"}),e.jsx("col",{width:"220px"}),e.jsx("col",{width:"*"}),e.jsx("col",{width:"120px"})]}),e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"신청일"}),e.jsx("th",{children:"신청유형"}),e.jsx("th",{children:"이름"}),e.jsx("th",{children:"이메일"}),e.jsx("th",{children:"휴대전화"}),e.jsx("th",{children:"단체명"}),e.jsx("th",{}),e.jsx("th",{children:"상세 보기"})]})}),e.jsx("tbody",{children:t&&(t==null?void 0:t.items.map(c=>e.jsxs("tr",{children:[e.jsx("td",{children:Ee(c.created_at)}),e.jsx("td",{children:c.type===0?"개인 신청":"단체 신청"}),e.jsx("td",{children:c.name}),e.jsx("td",{children:c.email}),e.jsx("td",{children:c.contact}),e.jsx("td",{children:c.group}),e.jsx("td",{}),e.jsx("td",{children:e.jsx("button",{onClick:()=>{d(c.id)},className:"col_blue underline",children:"상세 보기"})})]},c.id)))})]}):e.jsx("div",{children:"해당하는 참가자가 없습니다. "}),i===!0&&e.jsx(nc,{applyId:a,setDetailPopUp:s})]})},rc=[{value:"오늘",type:"today"},{value:"어제",type:"yesterday"},{value:"7일",type:"7days"},{value:"1개월",type:"1month"},{value:"전체",type:"all"}],oc=[{value:"개인 신청",type:0},{value:"단체 신청",type:1}],lc=({setFilterData:t,resetFilter:i})=>{const[s,a]=n.useState(),r=ye().format("YYYY-MM-DD"),{register:d,handleSubmit:c,setValue:o,reset:l}=ve(),p=m=>{let u="",w=ye().format("YYYY-MM-DD");switch(m){case"today":u=ye().format("YYYY-MM-DD");break;case"yesterday":u=ye().subtract(1,"day").format("YYYY-MM-DD"),w=u;break;case"7days":u=ye().subtract(7,"day").format("YYYY-MM-DD");break;case"1month":u=ye().subtract(1,"month").format("YYYY-MM-DD");break;case"all":u="",w="";break}o("start",u),o("end",w),a(m)},f=()=>{a(null)},g=m=>{t(m)},x=()=>{l(),i()};return e.jsxs("form",{onSubmit:c(g),children:[e.jsx("div",{className:"table_wrap mt_20",children:e.jsxs("table",{className:"type3",children:[e.jsxs("colgroup",{children:[e.jsx("col",{width:"160px"}),e.jsx("col",{width:"*"})]}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("th",{className:"txt_left",children:"기간"}),e.jsxs("td",{children:[rc.map(m=>e.jsxs("div",{className:"dis_inblock",children:[e.jsx("input",{type:"radio",name:"dateFilter",id:m.type,onChange:()=>p(m.type),checked:s===m.type,className:"hide"}),e.jsx("label",{htmlFor:m.type,className:"btn border_w",children:m.value})]},m.type)),e.jsxs("div",{className:"dis_inblock",children:[e.jsx("input",{type:"date",...d("start"),id:"start",onClick:f,onChange:m=>o("start",m.target.value),defaultValue:r,className:"small w_104"}),e.jsx("label",{htmlFor:"start",className:"date_icon"})]}),e.jsx("div",{className:"dis_inblock",children:" ~ "}),e.jsxs("div",{className:"dis_inblock",children:[e.jsx("input",{type:"date",...d("end"),id:"end",onClick:f,onChange:m=>o("end",m.target.value),defaultValue:r,className:"small w_104"}),e.jsx("label",{htmlFor:"end",className:"date_icon"})]})]})]}),e.jsxs("tr",{children:[e.jsx("th",{className:"txt_left",children:"검색"}),e.jsxs("td",{children:[e.jsx("div",{className:"dis_inblock",children:e.jsx("select",{...d("type"),className:"btn border_w w_96",children:oc.map(m=>e.jsx("option",{value:m.type,children:m.value},m.type))})}),e.jsx("div",{className:"dis_inblock",children:e.jsx("input",{type:"text",placeholder:"전체",...d("search"),className:"small search w_548"})})]})]})]})]})}),e.jsxs("div",{className:"btn_wrap mt_18",children:[e.jsx("button",{className:"btn small w_83 light_blue",type:"submit",children:"검색"}),e.jsx("button",{className:"btn small w_83 light_gray ml_4",type:"button",onClick:()=>x(),children:"초기화"})]})]})},dc=()=>{var H,L,z,B;const[t,i]=n.useState({}),[s,a]=n.useState(),[r,d]=n.useState(1),c=Ue(),o=$(),l=c.authInfo,p=st(),{openToast:f}=ke(),{id:g}=ge(),{data:x}=la(g,l.token),{data:m}=da(g,l.token);n.useEffect(()=>{const O={page:r??1,start:t.start,end:t.end,type:t.type,search:t.search,order:t.order??"asc"},h=Object.fromEntries(Object.entries(O).filter(([S,j])=>typeof j=="string"||Array.isArray(j)?j!==""&&j.length>0:j!=null).map(([S,j])=>[S,String(j)])),C=new URLSearchParams(h).toString();a(C)},[t,r]),n.useEffect(()=>{s&&(o(`?${s}`),p.invalidateQueries({queryKey:["EventPartyQuery"]}))},[s]);const u=()=>{i({}),d(1),o("?")},w=()=>{i({...t,order:t.order==="desc"?"asc":"desc"})},_=()=>{if(m){const O=new Blob([m],{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}),h=window.URL.createObjectURL(O),C=document.createElement("a");C.href=h,C.download="party_list.xlsx",document.body.appendChild(C),C.click(),document.body.removeChild(C),window.URL.revokeObjectURL(h)}else f("Excel 파일 데이터를 불러오는 데 실패했습니다.")};return e.jsx("div",{className:"cont_area",children:e.jsxs("div",{className:"cont_panel",children:[e.jsxs("div",{className:"tit_wrap",children:[e.jsx("h3",{className:"fs_40",children:"참가자 관리"}),e.jsx("button",{onClick:_,className:"download_btn"})]}),e.jsx(lc,{setFilterData:i,resetFilter:u}),e.jsx("div",{className:"tit_wrap mt_30",children:e.jsxs("div",{children:[e.jsxs("h3",{className:"tit",children:[e.jsx("span",{children:t.search?t.search:"전체"}),e.jsx("span",{className:"col_gray",children:"검색결과"}),e.jsx("span",{className:"fs_16",children:`[총 회원수 ${((H=x==null?void 0:x.data)==null?void 0:H.total)>0?(L=x==null?void 0:x.data)==null?void 0:L.total:0}명]`})]}),e.jsx("button",{onClick:w,className:"sort_btn",children:"정렬"})]})}),e.jsx(ac,{partyList:x==null?void 0:x.data}),((z=x==null?void 0:x.data)==null?void 0:z.total)>20&&e.jsx(ms,{total:(B=x==null?void 0:x.data)==null?void 0:B.total,page:r,setPage:d})]})})},vi=10*1024*1024,cc=()=>{var S,j;const[t,i]=n.useState(null),[s,a]=n.useState(null),[r,d]=n.useState(null),[c,o]=n.useState(!1),l=Ea(),p=localStorage.getItem("token"),{id:f}=ge(),{openToast:g}=ke(),{data:x}=Sa(f,p);console.log(s),n.useEffect(()=>{var N,V;(N=x==null?void 0:x.data)!=null&&N.img_name&&i(new File([],x.data.img_name)),(V=x==null?void 0:x.data)!=null&&V.xlsx_name&&a(new File([],x.data.xlsx_name))},[x]);const{register:m,handleSubmit:u,setValue:w,setError:_,formState:{errors:H}}=ve(),L=(N,V)=>{if(N&&N.length>0){const y=N[0];console.log(y);const A=["image/jpeg","image/tiff","application/pdf","image/png"],v=["application/vnd.openxmlformats-officedocument.spreadsheetml.sheet","application/vnd.ms-excel","application/haansoftxlsx"];if(V==="img"&&A.includes(y.type)){if(y.size>vi){d("이미지 파일의 크기는 10MB 이하이어야 합니다."),i(null),w("img",null);return}d(null),i(y),w("img",y)}else if(V==="xlsx"&&v.includes(y.type)){if(y.size>vi){d("엑셀 파일의 크기는 10MB 이하이어야 합니다."),a(null),w("xlsx",null);return}d(null),a(y),w("xlsx",y)}else{d("JPG, TIF, PDF, PNG 또는 엑셀 파일만 업로드 가능합니다."),i(null),a(null),w("img",null),w("xlsx",null);return}}else d(null),i(null),a(null),w("img",null),w("xlsx",null)},z=N=>{N.preventDefault(),o(!0)},B=()=>{o(!1)},O=(N,V)=>{N.preventDefault(),o(!1);const y=N.dataTransfer.files;L(y,V)},h=N=>(N/1024/1024).toFixed(2),C=u(()=>{const N=new FormData,V=(y,A)=>{A!=null&&!(A instanceof File&&A.size===0)&&N.append(y,A)};V("img",t??void 0),V("xlsx",s??void 0),l.mutate({token:p,event_id:f,formData:N},{onSuccess:()=>{g("저장 되었습니다.")},onError:()=>{l.error.response.data.data&&_("apiError",{type:"manual",message:"파일을 모두 등록해주세요"})}})});return e.jsx("div",{className:"cont_area",children:e.jsxs("div",{className:"cont_panel",children:[e.jsx("div",{className:"tit_wrap mt_44",children:e.jsx("h2",{className:"fs_40",children:"참가기업 관리"})}),e.jsx("div",{className:"tit_wrap mt_55",children:e.jsxs("h3",{className:"fs_18",children:["부스배치도 & 기업 리스트 ",e.jsx("span",{className:"col_red",children:"*"})]})}),e.jsx("div",{className:"tit_wrap mt_10",children:e.jsxs("p",{className:"fs_16 fw_500 col_gray",children:["행사 부스 배치도와 기업 리스트를 등록해 주세요.",e.jsx("br",{}),"사전등록을 신청한 참관객에게",e.jsx("a",{href:"#none",className:"col_white underline",children:"마이스 메이트 AI 부스추천 서비스"}),"가 맞춤 부스를 추천해드립니다."]})}),e.jsxs("form",{onSubmit:C,children:[e.jsxs("div",{className:"dis_flex mt_24 pr_52 gap38",children:[e.jsxs("div",{onDragOver:z,onDragLeave:B,onDrop:N=>O(N,"img"),className:"enroll_gray_box flex1",children:[e.jsx("h4",{className:"fs_24",children:"부스배치도 이미지를 등록해주세요"}),e.jsxs("p",{className:"fs_16 mt_14",children:["JPG, TIF, PDF, PNG 파일만 등록 가능하며, 용량은 10MB 이하로 업로드 가능합니다.",e.jsx("br",{}),"부스배치도 이미지 내, 업체명이 기입된 파일로 등록해주실길 바랍니다."]}),e.jsxs("div",{className:"btn_wrap mt_36",children:[e.jsx("a",{href:"/host/downloadFile/[마이스메이트]예시_부스배치도.pdf",download:"[마이스메이트]예시_부스배치도.pdf",className:"btn white",children:"부스배치도 예시 이미지"}),e.jsx("input",{type:"file",id:"img",...m("img"),onChange:N=>L(N.target.files,"img"),className:"hide"}),e.jsx("label",{htmlFor:"img",className:"btn dark_blue",children:"업로드 파일 선택"})]}),e.jsx("p",{className:"fs_16 mt_10 fw_500",children:"또는 여기에 끌어서 놓기"})]}),e.jsxs("div",{onDragOver:z,onDragLeave:B,onDrop:N=>O(N,"xlsx"),className:"enroll_gray_box flex1",children:[e.jsx("h4",{className:"fs_24",children:"기업 리스트를 등록해주세요"}),e.jsxs("p",{className:"fs_16 mt_14",children:["xlsx 파일만 등록 가능하며, 용량은 10MB 이하로 업로드 가능합니다.",e.jsx("br",{}),"기업 리스트는 마이스 메이트에서 제공하는 양식에 맞춰 등록해주시길 바랍니다."]}),e.jsxs("div",{className:"btn_wrap mt_36",children:[e.jsx("a",{href:"/host/downloadFile/[마이스메이트]참가기업리스트.xlsx",download:"[마이스메이트]참가기업리스트.xlsx",className:"btn white",children:"기업 리스트 엑셀 양식"}),e.jsx("input",{type:"file",id:"xlsx",...m("xlsx"),onChange:N=>L(N.target.files,"xlsx"),className:"hide"}),e.jsx("label",{htmlFor:"xlsx",className:"btn dark_blue",children:"업로드 파일 선택"})]}),e.jsx("p",{className:"fs_16 mt_10 fw_500",children:"또는 여기에 끌어서 놓기"})]})]}),e.jsxs("div",{className:"dis_flex pr_52 gap38",children:[e.jsx("div",{className:"flex1",children:t&&e.jsxs("div",{className:"file_upload_item",children:[e.jsx("i",{className:"file_icon"}),e.jsxs("div",{className:"flex1",children:[e.jsx("p",{className:"fs_12",children:t.name}),t.size>0&&e.jsx("p",{className:"fs_10",children:`${h(t.size)}mb`})]}),e.jsx("i",{className:"chk_icon"})]})}),e.jsx("div",{className:"flex1",children:s&&e.jsxs("div",{className:"file_upload_item",children:[e.jsx("i",{className:"file_icon"}),e.jsxs("div",{className:"flex1",children:[e.jsx("p",{className:"fs_12",children:s.name}),s.size>0&&e.jsx("p",{className:"fs_10",children:`${h(s.size)}mb`})]}),e.jsx("i",{className:"chk_icon"})]})})]}),r&&e.jsx("p",{className:"err_msg",style:{paddingTop:"20px"},children:r}),H.apiError&&e.jsx("p",{style:{paddingTop:"10px"},className:"err_msg",children:(j=(S=H.apiError)==null?void 0:S.message)==null?void 0:j.toString()}),e.jsxs("div",{className:"dis_flex justify_between mt_48",children:[e.jsx("div",{className:"btn_wrap"}),e.jsxs("div",{className:"btn_wrap gap23",children:[e.jsx("button",{type:"submit",className:"btn blue_bor",children:"임시저장"}),e.jsx("button",{type:"submit",className:"btn dark_blue",children:"등록하기"})]})]})]})]})})},pc=()=>e.jsx("div",{className:"cont_area",children:e.jsx("div",{className:"cont_panel min_h_864",children:e.jsx("div",{className:"inner",children:e.jsxs("div",{className:"txt_center mt_190",children:[e.jsx("p",{className:"fs_24 fw_700",children:"행사 등록이 완료되었습니다"}),e.jsxs("p",{className:"fs_24 fw_500 mt_44",children:["현재 행사는 ",e.jsx("b",{children:"승인 대기 상태"}),"입니다.",e.jsx("br",{}),"24시간 이내 처리가 완료될 예정이며, ",e.jsx("br",{}),"심사결과는 이메일로 전송됩니다."]}),e.jsx("div",{className:"btn_wrap mt_44",children:e.jsx(E,{to:"/host/my/dashboard",className:"btn dark_blue w_384",children:"대시보드로 돌아가기"})})]})})})}),xc=b.div`
  color: #fff;
  /* button */
  .btn {
    display: inline-flex;
