      ...
      <div className="cont_panel type2">
        ...
        <div className="dis_flex align_start justify_between pr_52 mt_14">
          <div className="survey_card w_767">
            <div className="head">
              <input type="text" placeholder="Q. 제목을 입력해주세요." />
            </div>
            <div className="body">
              <input type="text" placeholder="A. 답변을 입력해주세요." />
            </div>
            <div className="btm">
        ...
        <div className="dis_flex align_start justify_between pr_52 mt_10">
          <input className="w_767" type="text" value="이름" />
        </div>
        <div className="dis_flex align_start justify_between pr_52 mt_10">
          <input className="w_767" type="text" value="이메일" />
        </div>
        <div className="dis_flex align_start justify_between pr_52 mt_10">
          <input className="w_767" type="text" value="휴대전화 번호" />
        </div>

        <div className="dis_flex justify_between mt_48">
          <div className="btn_wrap"></div>
          <div className="btn_wrap gap23">
            <button className="btn dark_blue">저장</button>
            <button className="btn dark_blue">행사 게시</button>
          </div>
        </div>
      </div>
    </div>
