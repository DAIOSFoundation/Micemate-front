...
const ApplyPreviewPage = ({ target, setClose }) => {
  const token = localStorage.getItem("token");
  const { data: eventDetail } = useEventDetail(target, token);
          ...
          <div className="info_wrap">
            ...
            ${dateStringFormat(eventDetail?.data?.event_end_date)}`}
              ...
              {preview && (
                <div id="_detail">
                  <div className="tit">상세 정보</div>
                  <div className="detail_imgs" style={{ maxHeight: "auto" }}>
                    <div
                      dangerouslySetInnerHTML={{
                        __html: eventDetail?.data?.content,
                      }}
              ...
              <div id="_call">
                ...
                <ul className="key_val_list">
                  <li>
                    ...
                    <div className="val">{eventDetail?.data?.contact_name}</div>
                  </li>
                  <li>
